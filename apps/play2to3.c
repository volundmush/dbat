...
struct THREE_char_point_data {
  int16_t mana;
  int16_t max_mana;		/* Max mana for PC/NPC                     */
  int16_t hit;
  int16_t max_hit;		/* Max hit for PC/NPC                      */
  int16_t move;
  int16_t max_move;		/* Max move for PC/NPC                     */
...
struct THREE_player_special_data_saved {
  int8_t skills[THREE_MAX_SKILLS + 1];	/* array of skills plus skill 0 */
  int8_t spells_to_learn;		/* How many can you learn yet this level */
...
struct THREE_affected_type {
  ...
  int8_t modifier;		/* This is added to apropriate ability     */
...
struct TWO_char_point_data {
  int16_t mana;
  int16_t max_mana;		/* Max move for PC/NPC                     */
  int16_t hit;
  int16_t max_hit;		/* Max hit for PC/NPC                      */
  int16_t move;
  int16_t max_move;		/* Max move for PC/NPC                     */
...
struct TWO_affected_type {
  int8_t type;			/* The type of spell that caused this      */
  int16_t duration;		/* For how long its effects will last      */
  int8_t modifier;		/* This is added to apropriate ability     */
  int8_t location;		/* Tells which ability to change(APPLY_XXX) */
  long bitvector;		/* Tells which bits to set (AFF_XXX)       */
