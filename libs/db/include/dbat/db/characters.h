...
struct char_data
{
   ...
   bitvector_t school_feats[SFEAT_MAX + 1]; /* One bitvector array per CFEAT_ type	*/
   int ship;
   room_vnum shipr;
   short stupidkiss;
   int64_t suppressed;
