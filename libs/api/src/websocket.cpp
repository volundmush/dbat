...
namespace dbat::api
{
    namespace
    {
        ...
        {
            volcano::web::WebSocketStream &ws;
            volcano::web::RequestContext &data;
    ...
    boost::asio::awaitable<void> handle_play(volcano::web::WebSocketStream &ws, volcano::web::RequestContext &data)
    {
