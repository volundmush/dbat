...
#include "dbat/mud/ClientData.hpp"
...
namespace dbat::link
{
    ...
    using ResponseChannel = Channel<dbat::web::HttpAnswer>;
    ...
    boost::asio::awaitable<dbat::web::HttpAnswer> send_request_and_reply(dbat::web::RequestContext &ctx, NetRequest &&request);
    ...
    struct GameConnectionInfo
    {
        ...
        dbat::mud::ClientData client_data;
    };
