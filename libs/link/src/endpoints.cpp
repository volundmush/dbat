...
namespace dbat::link {
    ...
    boost::asio::awaitable<dbat::web::HttpAnswer> handle_auth_register_post(dbat::net::AnyStream &conn, dbat::web::RequestContext& data) {
        UserRegisterReq req;
    ...
    boost::asio::awaitable<dbat::web::HttpAnswer> handle_auth_login_post(dbat::net::AnyStream &conn, dbat::web::RequestContext& data) {
        UserLoginReq req;
        req.username = data.user_data["username"].get<std::string>();
        req.password = data.user_data["password"].get<std::string>();
        co_return co_await send_request_and_reply(data, NetRequest{std::move(req)});
    ...
    boost::asio::awaitable<dbat::web::HttpAnswer> handle_auth_refresh_post(dbat::net::AnyStream &conn, dbat::web::RequestContext& data) {
    ...
    boost::asio::awaitable<dbat::web::HttpAnswer> handle_character_get(dbat::net::AnyStream &conn, dbat::web::RequestContext& data) {
    ...
    boost::asio::awaitable<dbat::web::HttpAnswer> handle_character_post(dbat::net::AnyStream &conn, dbat::web::RequestContext& data) {
        auto sub = data.user_data["account_id"].get<int64_t>();
        if(auto json_res = dbat::web::parse_json_body(data.request); !json_res) {
    ...
    boost::asio::awaitable<dbat::web::HttpAnswer> handle_character_delete(dbat::net::AnyStream &conn, dbat::web::RequestContext& data) {
        auto sub = data.user_data["account_id"].get<int64_t>();
    ...
    boost::asio::awaitable<dbat::web::HttpAnswer> handle_mssp(dbat::net::AnyStream &conn, dbat::web::RequestContext& data) {
        MsspReq req;
        co_return co_await send_request_and_reply(data, NetRequest{std::move(req)});
    }

    std::shared_ptr<dbat::web::Router> init_router() {

        auto router = std::make_shared<dbat::web::Router>();
