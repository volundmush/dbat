...
ACMD(do_roundhouse) {
    ...
    if (!limb_ok(ch, 1)) {
        ...
        if (GET_LIMBCOND(ch, 3) < 0) {
            act("@RYour right leg has fallen apart!@n", true, ch, nullptr, nullptr, TO_CHAR);
            act("@r$n@R's right leg has fallen apart!@n", true, ch, nullptr, nullptr, TO_ROOM);
        }
        ...
        if (GET_LIMBCOND(ch, 4) < 0) {
            act("@RYour left leg has fallen apart!@n", true, ch, nullptr, nullptr, TO_CHAR);
            act("@r$n@R's left leg has fallen apart!@n", true, ch, nullptr, nullptr, TO_ROOM);
        }
    }
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if ((vict->getCurST()) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    ...
                    act("@C$N@W moves quickly and blocks your roundhouse!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W roundhouse!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W roundhouse!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W manages to dodge your roundhouse!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W roundhouse!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W roundhouse!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, nullptr, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    ...
                    break;
                case 2: /* Critical */
                    act("@WYou spin a fierce roundhouse into @C$N's@W gut!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W spins a fierce roundhouse into your gut!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@c$n@W spins a fierce roundhouse into @C$N's@W gut!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    if (!AFF_FLAGGED(vict, AFF_FLYING) && GET_POS(vict) == POS_STANDING && rand_number(1, 8) >= 7) {
                        handle_knockdown(vict);
                    }
                    dmg *= calc_critical(ch, 0);
                ...
                case 4: /* Weak */
                    ...
                    break;
                case 5: /* Weak 2 */
                    act("@WYou slam a roundhouse into @C$N's@W leg!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W slams a roundhouse into your leg!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@c$n@W slams a roundhouse into @C$N's@W leg!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(1, 195, ch, vict, nullptr, dmg, 0);
                    dam_eq_loc(vict, 2);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou roundhouse $p@W as hard as you can!@n", true, ch, obj, nullptr, TO_CHAR);
        act("@C$n@W roundhouses $p@W extremely hard!@n", true, ch, obj, nullptr, TO_ROOM);
        hurt(0, 0, ch, nullptr, obj, dmg, 0);
        pcost(ch, 0, stcost);
...
ACMD(do_elbow) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if ((vict->getCurST()) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    ...
                    act("@C$N@W blocks your elbow strike!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@WYou block @C$n's@W elbow strike!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@C$N@W blocks @c$n's@W elbow strike!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    ...
                    act("@C$N@W dodges your elbow strike!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W elbow strike!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@C$N@W dodges @c$n's@W elbow strike!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, nullptr, 0, 0);
                ...
                act("@WYou can't believe it, your elbow strike misses!@n", true, ch, nullptr, vict, TO_CHAR);
                act("@C$n@W throws an elbow stike at you, but thankfully misses!@n", true, ch, nullptr, vict, TO_VICT);
                act("@c$n@W throws an elbow strike at @C$N@W, but misses!@n", true, ch, nullptr, vict, TO_NOTVICT);
                hurt(0, 0, ch, vict, nullptr, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou slam your elbow into @C$N's@W body!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W slams $s elbow into your body!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@c$n@W slams $s elbow into @C$N's@W body!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, nullptr, dmg, 0);
                    ...
                    break;
                case 2: /* Critical */
                    act("@WYou slam your elbow into @C$N's@W face!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W slams $s elbow into your face!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@c$n@W slams $s elbow into @C$N's@W face!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 0);
                    hurt(0, 0, ch, vict, nullptr, dmg, 0);
                    dam_eq_loc(vict, 3);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 3:
                    act("@WYou land your elbow against @C$N's@W gut!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W lands $s elbow against your gut!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@C$n@W lands $s elbow against @C$N's@W gut!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, nullptr, dmg, 0);
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYou land your elbow against @C$N's@W leg!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W lands $s elbow against your leg!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@C$n@W lands $s elbow against @C$N's@W leg!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, nullptr, dmg, 0);
                    dam_eq_loc(vict, 2);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 5: /* Weak */
                    act("@WYou land your elbow against @C$N's@W arm!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W lands $s elbow against your arm!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@C$n@W lands $s elbow against @C$N's@W arm!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, nullptr, dmg, 0);
                    dam_eq_loc(vict, 1);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou elbow stike $p@W as hard as you can!@n", true, ch, obj, nullptr, TO_CHAR);
        act("@C$n@W elbow strikes $p@W extremely hard!@n", true, ch, obj, nullptr, TO_ROOM);
        hurt(0, 0, ch, nullptr, obj, dmg, 0);
        pcost(ch, 0, stcost);
...
ACMD(do_kick) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if ((vict->getCurST()) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your kick with a kick of $S own!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W kick with one of your own!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W kick with a kick of $S own!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(vict, -2, skill, attperc);
                    ...
                    act("@C$N@W blocks your kick!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@WYou block @C$n's@W kick!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@C$N@W blocks @c$n's@W kick!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(ch, 1, skill, attperc);
                    ...
                    act("@C$N@W dodges your kick!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W kick!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@C$N@W dodges @c$n's@W kick!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, nullptr, 0, 0);
                    ...
                    act("@WYou can't believe it, your kick misses!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W throws a kick at you, but thankfully misses!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@c$n@W throws a kick at @C$N@W, but misses!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, nullptr, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou slam your foot into @C$N's@W body!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W slams $s foot into your body!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@c$n@W slams $s foot into @C$N's@W body!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, nullptr, dmg, 0);
                    ...
                    break;
                case 2: /* Critical */
                    act("@WYou slam your foot into @C$N's@W face!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W slams $s foot into your face!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@c$n@W slams $s foot into @C$N's@W face!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 0);
                    hurt(0, 0, ch, vict, nullptr, dmg, 0);
                    dam_eq_loc(vict, 3);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 3:
                    act("@WYou land your foot against @C$N's@W gut!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W lands $s foot against your gut!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@C$n@W lands $s foot against @C$N's@W gut!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, nullptr, dmg, 0);
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYou land your foot against @C$N's@W leg!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W lands $s foot against your leg!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@C$n@W lands $s foot against @C$N's@W leg!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, nullptr, dmg, 0);
                    dam_eq_loc(vict, 2);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 5: /* Weak */
                    act("@WYou land your foot against @C$N's@W arm!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W lands $s foot against your arm!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@C$n@W lands $s foot against @C$N's@W arm!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, nullptr, dmg, 0);
                    dam_eq_loc(vict, 1);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou kick $p@W as hard as you can!@n", true, ch, obj, nullptr, TO_CHAR);
        act("@C$n@W kicks $p@W extremely hard!@n", true, ch, obj, nullptr, TO_ROOM);
        hurt(0, 0, ch, nullptr, obj, dmg, 0);
        pcost(ch, 0, stcost);
...
ACMD(do_knee) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if ((vict->getCurST()) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your knee with a knee of $S own!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W knee with one of your own!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W knee with a knee of $S own!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(vict, -2, skill, attperc);
                    ...
                    act("@C$N@W blocks your knee strike!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@WYou block @C$n's@W knee strike!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@C$N@W blocks @c$n's@W knee strike!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(ch, 3, skill, attperc);
                    ...
                    act("@C$N@W dodges your knee strike!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W knee strike!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@C$N@W dodges @c$n's@W knee strike!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, nullptr, 0, 0);
                ...
                act("@WYou can't believe it, your  knee strike misses!@n", true, ch, nullptr, vict, TO_CHAR);
                act("@C$n@W throws a knee stike at you, but thankfully misses!@n", true, ch, nullptr, vict, TO_VICT);
                act("@c$n@W throws a knee strike at @C$N@W, but misses!@n", true, ch, nullptr, vict, TO_NOTVICT);
                hurt(0, 0, ch, vict, nullptr, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou slam your knee into @C$N's@W body!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W slams $s knee into your body!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@c$n@W slams $s knee into @C$N's@W body!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, nullptr, dmg, 0);
                    ...
                    break;
                case 2: /* Critical */
                    act("@WYou slam your knee into @C$N's@W face!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W slams $s knee into your face!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@c$n@W slams $s knee into @C$N's@W face!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 0);
                    hurt(0, 0, ch, vict, nullptr, dmg, 0);
                    dam_eq_loc(vict, 3);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 3:
                    act("@WYou land your knee against @C$N's@W gut!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W lands $s knee against your gut!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@C$n@W lands $s knee against @C$N's@W gut!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, nullptr, dmg, 0);
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYou land your knee against @C$N's@W leg!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W lands $s knee against your leg!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@C$n@W lands $s knee against @C$N's@W leg!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, nullptr, dmg, 0);
                    dam_eq_loc(vict, 2);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 5: /* Weak */
                    act("@WYou land your knee against @C$N's@W arm!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W lands $s knee against your arm!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@C$n@W lands $s knee against @C$N's@W arm!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, nullptr, dmg, 0);
                    dam_eq_loc(vict, 1);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou knee stike $p@W as hard as you can!@n", true, ch, obj, nullptr, TO_CHAR);
        act("@C$n@W knee strikes $p@W extremely hard!@n", true, ch, obj, nullptr, TO_ROOM);
        hurt(0, 0, ch, nullptr, obj, dmg, 0);
        pcost(ch, 0, stcost);
...
ACMD(do_punch) {
    ...
    if (vict) {
        ...
        if (prob < perc - 20) {
            if ((vict->getCurST()) > 0) {
                if (pry > rand_number(1, 140) && (!IS_NPC(vict) || !MOB_FLAGGED(vict, MOB_DUMMY))) {
                    act("@C$N@W parries your punch with a punch of $S own!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@WYou parry @C$n's@W punch with a punch of your own!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@C$N@W parries @c$n's@W punch with a punch of $S own!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_PARRY, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(vict, -2, skill, attperc);
                    ...
                    act("@C$N@W moves quickly and blocks your punch!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@WYou move quickly and block @C$n's@W punch!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@C$N@W moves quickly and blocks @c$n's@W punch!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_BLOCK, 0);
                    pcost(ch, 0, stcost / 2);
                    pcost(vict, 0, GET_MAX_HIT(vict) / 500);
                    dmg = damtype(ch, 0, skill, attperc);
                    ...
                    act("@C$N@W manages to dodge your punch!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@WYou dodge @C$n's@W punch!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@C$N@W manages to dodge @c$n's@W punch!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    improve_skill(vict, SKILL_DODGE, 0);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, nullptr, 0, 0);
                    ...
                    act("@WYou can't believe it but your punch misses!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W throws a punch at you but somehow misses!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@c$n@W throws a punch at @C$N@W but somehow misses!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    pcost(ch, 0, stcost / 2);
                    hurt(0, 0, ch, vict, nullptr, 0, 0);
            ...
            switch (hitspot) {
                case 1:
                    act("@WYou slam your fist into @C$N's@W body!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W slams $s fist into your body!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@c$n@W slams $s fist into @C$N's@W body!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, nullptr, dmg, 0);
                    ...
                    break;
                case 2: /* Critical */
                    act("@WYou slam your fist into @C$N's@W face!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W slams $s fist into your face!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@c$n@W slams $s fist into @C$N's@W face!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 0);
                    hurt(0, 0, ch, vict, nullptr, dmg, 0);
                    dam_eq_loc(vict, 3);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 3:
                    act("@WYou punch @C$N@W directly in the gut!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W punches you directly in the gut!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@c$n@W punches @C$N@W directly in the gut!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    if (GET_BONUS(ch, BONUS_SOFT)) {
                        dmg *= calc_critical(ch, 2);
                    }
                    hurt(0, 0, ch, vict, nullptr, dmg, 0);
                    ...
                    break;
                case 4: /* Weak */
                    act("@WYou punch @C$N@W in the arm!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W punches you in the arm!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@c$n@W punches @C$N@W in the arm!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, nullptr, dmg, 0);
                    dam_eq_loc(vict, 1);
                    /* dam_eq_loc: 1 Arms, 2 legs, 3 head, and 4 body. */
                    break;
                case 5: /* Weak 2 */
                    act("@WYou punch @C$N@W in the leg!@n", true, ch, nullptr, vict, TO_CHAR);
                    act("@C$n@W punches you in the leg!@n", true, ch, nullptr, vict, TO_VICT);
                    act("@c$n@W punches @C$N@W in the arm!@n", true, ch, nullptr, vict, TO_NOTVICT);
                    dmg *= calc_critical(ch, 1);
                    hurt(0, 0, ch, vict, nullptr, dmg, 0);
                    dam_eq_loc(vict, 2);
        ...
        dmg = ((GET_HIT(ch) / 10000) + (GET_STR(ch)));
        act("@WYou punch $p@W as hard as you can!@n", true, ch, obj, nullptr, TO_CHAR);
        act("@C$n@W punches $p@W extremely hard!@n", true, ch, obj, nullptr, TO_ROOM);
        hurt(0, 0, ch, nullptr, obj, dmg, 0);
        pcost(ch, 0, stcost);
