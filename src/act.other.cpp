...
void load_shadow_dragons() {
    ...
    if (SHADOW_DRAGON1 > 0) {
        ...
        mob->addToLocation(getEntity(SHADOW_DRAGON1));
        mob = nullptr;
    }
    ...
    if (SHADOW_DRAGON2 > 0) {
        ...
        mob = read_mobile(r_num, REAL);
        mob->addToLocation(getEntity(SHADOW_DRAGON2));
        mob = nullptr;
    }
    ...
    if (SHADOW_DRAGON3 > 0) {
        ...
        mob = read_mobile(r_num, REAL);
        mob->addToLocation(getEntity(SHADOW_DRAGON3));
        mob = nullptr;
    }
    ...
    if (SHADOW_DRAGON4 > 0) {
        ...
        mob = read_mobile(r_num, REAL);
        mob->addToLocation(getEntity(SHADOW_DRAGON4));
        mob = nullptr;
    }
    ...
    if (SHADOW_DRAGON5 > 0) {
        ...
        mob = read_mobile(r_num, REAL);
        mob->addToLocation(getEntity(SHADOW_DRAGON5));
        mob = nullptr;
    }
    ...
    if (SHADOW_DRAGON6 > 0) {
        ...
        mob = read_mobile(r_num, REAL);
        mob->addToLocation(getEntity(SHADOW_DRAGON6));
        mob = nullptr;
    }
    ...
    if (SHADOW_DRAGON7 > 0) {
        ...
        mob = read_mobile(r_num, REAL);
        mob->addToLocation(getEntity(SHADOW_DRAGON7));
    }
        ...
        if (SELFISHMETER < 10) {
            switch (DRAGONC) {
                ...
                case 290:
                    ...
                    EDRAGON->addToLocation(getEntity(DRAGONR));
                    DRAGONC -= 1;
                    break;
                case 285:
...
ACMD(do_summon) {
    ...
    dragon->addToLocation(getEntity(0));;
...
ACMD(do_fix) {
    ...
    if (self == false) {
        ...
        if (obj->getCarriedBy() == nullptr && !PLR_FLAGGED(ch, PLR_REPLEARN) &&
