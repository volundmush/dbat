...
#if 0 // lua/characters/commands/misc/train.lua
ACMD(do_train) {
...
#endif // lua/characters/commands/misc/train.lua
...
void base_update(void) {
  ...
  char_iterate_subscriptions("player", [&](auto ch) {
    ...
    // tick_player_ash_curse moved to lua/characters/conditions/curse.lua
    tick_player_goop(ch);
