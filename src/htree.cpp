...
void htree_test() {
    ...
    log("htree stats (global): %d nodes, %" SZT" bytes (depth %d/%" SZT" used/possible)", htree_total_nodes,
        htree_total_nodes * sizeof(struct htree_node), htree_depth_used, HTREE_MAX_DEPTH);
}
