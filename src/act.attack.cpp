...
ACMD(do_lightgrenade) {
  ...
  if (skill < perc) {
    act("@WYou quickly bring your hands in front of your body and cup them a "
        "short distance from each other. A flash of @Ggreen @Ylight@W can be "
        "seen as your ki is condensed between your hands before a "
        "@Yg@yo@Yl@yd@Ye@yn@W orb of ki replaces the green light. Your "
        "concentration waivers however and the energy slips away from your "
        "control harmlessly!@n",
        TRUE, ch, 0, targ, TO_CHAR);
    act("@C$n@W quickly brings $s hands in front of $s body and cups them a "
        "short distance from each other. A flash of @Ggreen @Ylight@W can be "
        "seen as ki is condensed between $s hands before a "
        "@Yg@yo@Yl@yd@Ye@yn@W orb of ki replaces the green light. Suddenly $s "
        "concentration seems to waiver and the energy slips away from $s "
        "control harmlessly!@n",
        TRUE, ch, 0, targ, TO_VICT);
    act("@C$n@W quickly brings $s hands in front of $s body and cups them a "
        "short distance from each other. A flash of @Ggreen @Ylight@W can be "
        "seen as ki is condensed between $s hands before a "
        "@Yg@yo@Yl@yd@Ye@yn@W orb of ki replaces the green light. Suddenly $s "
  ...
  act("@WYou quickly bring your hands in front of your body and cup them a "
      "short distance from each other. A flash of @Ggreen @Ylight@W can be "
      "seen as your ki is condensed between your hands before a "
      "@Yg@yo@Yl@yd@Ye@yn@W orb of ki replaces the green light. You shout "
      "@r'@YLIGHT GRENADE@r'@W as the orb launches from your hands at "
      "@C$N@W!@n",
      TRUE, ch, 0, targ, TO_CHAR);
  act("@C$n@W quickly brings $s hands in front of $s body and cups them a "
      "short distance from each other. A flash of @Ggreen @Ylight@W can be "
      "seen as ki is condensed between $s hands before a @Yg@yo@Yl@yd@Ye@yn@W "
      "orb of ki replaces the green light. @C$n shouts @r'@YLIGHT GRENADE@r'@W "
      "as the orb launches from $s hands at YOU!@n",
      TRUE, ch, 0, targ, TO_VICT);
  act("@C$n@W quickly brings $s hands in front of $s body and cups them a "
      "short distance from each other. A flash of @Ggreen @Ylight@W can be "
      "seen as ki is condensed between $s hands before a @Yg@yo@Yl@yd@Ye@yn@W "
      "orb of ki replaces the green light. @C$n shouts @r'@YLIGHT GRENADE@r'@W "
      "as the orb launches from $s hands at @c$N@W!@n",
      TRUE, ch, 0, targ, TO_NOTVICT);
  ...
  room_people_iterate(char_room_get(ch), [&](auto vict) {
    ...
    if (dge > axion_dice(skill * 0.5) && vict == targ) {
      ...
      act("@c$N@W manages to dodge the light grenade!@n", TRUE, ch, 0, vict,
          TO_CHAR);
      act("@WYou manages to dodge the light grenade!@n", TRUE, ch, 0, vict,
          TO_VICT);
      act("@c$N@W manages to dodge the light grenade!@n", TRUE, ch, 0, vict,
          TO_NOTVICT);
    ...
    if (prob < perc - 20) {
      if ((getCurST(vict)) > 0) {
        if (dge > rand_number(1, 130)) {
          act("@C$N@W manages to dodge your Sundering Force, letting it fly "
              "harmlessly by!@n",
              FALSE, ch, 0, vict, TO_CHAR);
          act("@WYou dodge @C$n's@W Sundering Force, letting it fly harmlessly "
              "by!@n",
              FALSE, ch, 0, vict, TO_VICT);
          act("@C$N@W manages to dodge @c$n's@W Sundering Force, letting it "
              "fly harmlessly by!@n",
              FALSE, ch, 0, vict, TO_NOTVICT);
          pcost(ch, attperc, 0);
          hurt(0, 0, ch, vict, NULL, 0, 1);
          ...
          act("@WYou can't believe it but your Sundering Force misses, flying "
              "through the air harmlessly!@n",
              FALSE, ch, 0, vict, TO_CHAR);
          act("@C$n@W fires a Sundering Force at you, but misses!@n ", FALSE,
              ch, 0, vict, TO_VICT);
          act("@c$n@W fires a Sundering Force at @C$N@W, but somehow "
              "misses!@n ",
              FALSE, ch, 0, vict, TO_NOTVICT);
          pcost(ch, attperc, 0);
          hurt(0, 0, ch, vict, NULL, 0, 1);
        ...
        act("@WYou can't believe it but your Sundering Force misses, flying "
            "through the air harmlessly!@n",
            FALSE, ch, 0, vict, TO_CHAR);
        act("@C$n@W fires a Sundering Force at you, but misses!@n", FALSE, ch,
            0, vict, TO_VICT);
        act("@c$n@W fires a Sundering Force at @C$N@W, but somehow misses!@n",
            FALSE, ch, 0, vict, TO_NOTVICT);
        pcost(ch, attperc, 0);
      }
      hurt(0, 0, ch, vict, NULL, 0, 1);
      ...
      switch (hitspot) {
      case 1:
        act("@WYou raise both hands and aim the flats of your palms toward "
            "@c$N@W. As you concentrate your charged ki long arcing beams of "
            "blue energy shoot out and form a field around $M. With a quick "
            "motion you move your hands in opposite directions and wrench "
            "@c$N's@W body with the force of your energy!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n@W raises both hands and aims the flats of $s palms toward "
            "YOU. As $e concentrates $s charged ki long arcing beams of blue "
            "energy shoot out and form a field around YOU. With a quick motion "
            "$e moves $s hands in opposite directions and wrenches YOUR body "
            "with the force of $s energy!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n@W raises both hands and aims the flats of $s palms toward "
            "@c$N@W. As $e concentrates $s charged ki long arcing beams of "
            "blue energy shoot out and form a field around @c$N@W. With a "
            "quick motion @C$n@W moves $s hands in opposite directions and "
            "wrenches @c$N's@W body with the force of $s energy!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        if (GET_BONUS(ch, BONUS_SOFT)) {
          dmg *= calc_critical(ch, 2);
        }
      ...
      case 2: /* Critical */
        act("@WYou raise both hands and aim the flats of your palms toward "
            ...
            "blue energy shoot out and form a field around $M. With a quick "
            "motion you move your hands in opposite directions and wrench "
            "@c$N's@W head with the force of your energy!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n@W raises both hands and aims the flats of $s palms toward "
            "YOU. As $e concentrates $s charged ki long arcing beams of blue "
            "energy shoot out and form a field around YOU. With a quick motion "
            "$e moves $s hands in opposite directions and wrenches YOUR head "
            "with the force of $s energy!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n@W raises both hands and aims the flats of $s palms toward "
            "@c$N@W. As $e concentrates $s charged ki long arcing beams of "
            "blue energy shoot out and form a field around @c$N@W. With a "
            "quick motion @C$n@W moves $s hands in opposite directions and "
            "wrenches @c$N's@W head with the force of $s energy!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        dmg *= calc_critical(ch, 0);
        hurt(0, 0, ch, vict, NULL, dmg, 1);
        dam_eq_loc(vict, 3);
      ...
      case 4: /* Weak */
        act("@WYou raise both hands and aim the flats of your palms toward "
            ...
            "blue energy shoot out and form a field around $M. With a quick "
            "motion you move your hands in opposite directions and wrench "
            "@c$N's@W arm with the force of your energy!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n@W raises both hands and aims the flats of $s palms toward "
            "YOU. As $e concentrates $s charged ki long arcing beams of blue "
            "energy shoot out and form a field around YOU. With a quick motion "
            "$e moves $s hands in opposite directions and wrenches YOUR arm "
            "with the force of $s energy!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n@W raises both hands and aims the flats of $s palms toward "
            "@c$N@W. As $e concentrates $s charged ki long arcing beams of "
            "blue energy shoot out and form a field around @c$N@W. With a "
            "quick motion @C$n@W moves $s hands in opposite directions and "
            "wrenches @c$N's@W arm with the force of $s energy!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        dmg *= calc_critical(ch, 1);
        hurt(0, 160, ch, vict, NULL, dmg, 1);
        dam_eq_loc(vict, 2);
      ...
      case 5: /* Weak */
        act("@WYou raise both hands and aim the flats of your palms toward "
            ...
            "blue energy shoot out and form a field around $M. With a quick "
            "motion you move your hands in opposite directions and wrench "
            "@c$N's@W leg with the force of your energy!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n@W raises both hands and aims the flats of $s palms toward "
            "YOU. As $e concentrates $s charged ki long arcing beams of blue "
            "energy shoot out and form a field around YOU. With a quick motion "
            "$e moves $s hands in opposite directions and wrenches YOUR leg "
            "with the force of $s energy!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n@W raises both hands and aims the flats of $s palms toward "
            "@c$N@W. As $e concentrates $s charged ki long arcing beams of "
            "blue energy shoot out and form a field around @c$N@W. With a "
            "quick motion @C$n@W moves $s hands in opposite directions and "
            "wrenches @c$N's@W leg with the force of $s energy!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        dmg *= calc_critical(ch, 1);
        hurt(1, 160, ch, vict, NULL, dmg, 1);
        dam_eq_loc(vict, 1);
...
ACMD(do_zen) {
  ...
  if (vict) {
    ...
    if (prob < perc - 20) {
      if ((getCurST(vict)) > 0) {
        if (blk > rand_number(1, 130)) {
          act("@C$N@W moves quickly and blocks your Zen Blade Strike!@n", FALSE,
              ch, 0, vict, TO_CHAR);
          act("@WYou move quickly and block @C$n's@W Zen Blade Strike!@n",
              FALSE, ch, 0, vict, TO_VICT);
          act("@C$N@W moves quickly and blocks @c$n's@W Zen Blade Strike!@n",
              FALSE, ch, 0, vict, TO_NOTVICT);
          if (GET_SKILL_PERF(ch, SKILL_ZEN) == 3 && attperc > minimum) {
            pcost(ch, attperc - 0.05, 0);
          } else {
          ...
          act("@C$N@W manages to dodge your Zen Blade Strike, letting it slam "
              "into the surroundings!@n",
              FALSE, ch, 0, vict, TO_CHAR);
          act("@WYou dodge @C$n's@W Zen Blade Strike, letting it slam into the "
              "surroundings!@n",
              FALSE, ch, 0, vict, TO_VICT);
          act("@C$N@W manages to dodge @c$n's@W Zen Blade Strike, letting it "
          ...
          dodge_ki(ch, vict, 0, 19, skill,
                   SKILL_ZEN); /* Effects on the room from dodging a ki attack
        ...
        Num 2: [ Number of attack for damtype ]*/
          ...
          act("@WYou can't believe it but your Zen Blade Strike misses, flying "
              "through the air harmlessly!@n",
              FALSE, ch, 0, vict, TO_CHAR);
          act("@C$n@W fires a Zen Blade Strike at you, but misses!@n ", FALSE,
              ch, 0, vict, TO_VICT);
          act("@c$n@W fires a Zen Blade Strike at @C$N@W, but somehow "
              "misses!@n ",
              FALSE, ch, 0, vict, TO_NOTVICT);
        ...
        act("@WYou can't believe it but your Zen Blade Strike misses, flying "
            "through the air harmlessly!@n",
            FALSE, ch, 0, vict, TO_CHAR);
        act("@C$n@W fires a Zen Blade Strike at you, but misses!@n", FALSE, ch,
            0, vict, TO_VICT);
        act("@c$n@W fires a Zen Blade Strike at @C$N@W, but somehow misses!@n",
            FALSE, ch, 0, vict, TO_NOTVICT);
        if (GET_SKILL_PERF(ch, SKILL_ZEN) == 3 && attperc > minimum) {
          pcost(ch, attperc - 0.05, 0);
        } else {
      ...
      switch (hitspot) {
      case 1:
        act("@CRaising your blade above your head, and closing your eyes, you "
            "focus ki into its edge. The edge of the blade begins to glow a "
            "soft blue as the blade begins to throb with excess energy. Peels "
            "of lighting begin to arc from the blade in all directions as you "
            "open your eyes and instantly move past @g$N's@C body while "
            "slashing with the pure energy of your resolve! A large explosion "
            "of energy erupts across $S body!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@G$n @Craises $s blade above $s head, and closes $s eyes. The "
            "edge of the blade begins to glow a soft blue as the blade begins "
            "to throb with excess energy. Peels of lighting begin to arc from "
            "the blade in all directions as $e opens $s eyes and instantly "
            "moves past YOUR body while slashing with the pure energy of $s "
            "resolve! A large explosion of energy erupts across YOUR body!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@G$n @Craises $s blade above $s head, and closes $s eyes. The "
            "edge of the blade begins to glow a soft blue as the blade begins "
            "to throb with excess energy. Peels of lighting begin to arc from "
            "the blade in all directions as $e opens $s eyes and instantly "
            "moves past @g$N's@C body while slashing with the pure energy of "
            "$s resolve! A large explosion of energy erupts across @g$N's@C "
            "body!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        if (GET_BONUS(ch, BONUS_SOFT)) {
          dmg *= calc_critical(ch, 2);
      ...
      case 2: /* Critical */
        act("@CRaising your blade above your head, and closing your eyes, you "
            ...
            "open your eyes and instantly move past @g$N's@C body while "
            "slashing with the pure energy of your resolve! A large explosion "
            "of energy erupts across $S head!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@G$n @Craises $s blade above $s head, and closes $s eyes. The "
            "edge of the blade begins to glow a soft blue as the blade begins "
            "to throb with excess energy. Peels of lighting begin to arc from "
            "the blade in all directions as $e opens $s eyes and instantly "
            "moves past YOUR body while slashing with the pure energy of $s "
            "resolve! A large explosion of energy erupts across YOUR head!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@G$n @Craises $s blade above $s head, and closes $s eyes. The "
            "edge of the blade begins to glow a soft blue as the blade begins "
            "to throb with excess energy. Peels of lighting begin to arc from "
      ...
      case 4: /* Weak */
        act("@CRaising your blade above your head, and closing your eyes, you "
            ...
            "open your eyes and instantly move past @g$N's@C body while "
            "slashing with the pure energy of your resolve! A large explosion "
            "of energy erupts across $S arm!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@G$n @Craises $s blade above $s head, and closes $s eyes. The "
            "edge of the blade begins to glow a soft blue as the blade begins "
            "to throb with excess energy. Peels of lighting begin to arc from "
            "the blade in all directions as $e opens $s eyes and instantly "
            "moves past YOUR body while slashing with the pure energy of $s "
            "resolve! A large explosion of energy erupts across YOUR arm!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@G$n @Craises $s blade above $s head, and closes $s eyes. The "
            "edge of the blade begins to glow a soft blue as the blade begins "
            "to throb with excess energy. Peels of lighting begin to arc from "
            ...
            TRUE, ch, 0, vict, TO_NOTVICT);
        dmg *= calc_critical(ch, 1);
        if (rand_number(1, 100) >= 80 && !IS_NPC(vict) &&
      ...
      case 5: /* Weak 2 */
        act("@CRaising your blade above your head, and closing your eyes, you "
            ...
            "open your eyes and instantly move past @g$N's@C body while "
            "slashing with the pure energy of your resolve! A large explosion "
            "of energy erupts across $S leg!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@G$n @Craises $s blade above $s head, and closes $s eyes. The "
            "edge of the blade begins to glow a soft blue as the blade begins "
            "to throb with excess energy. Peels of lighting begin to arc from "
            "the blade in all directions as $e opens $s eyes and instantly "
            "moves past YOUR body while slashing with the pure energy of $s "
            "resolve! A large explosion of energy erupts across YOUR leg!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@G$n @Craises $s blade above $s head, and closes $s eyes. The "
            "edge of the blade begins to glow a soft blue as the blade begins "
            "to throb with excess energy. Peels of lighting begin to arc from "
    ...
    act("@C$n@W fires a Zen Blade Strike at $p@W!@n", FALSE, ch, obj, 0,
        TO_ROOM);
    hurt(0, 0, ch, NULL, obj, dmg, 0);
    pcost(ch, attperc, 0);
...
ACMD(do_malice) {
  ...
  if (vict) {
    ...
    if (prob < perc - 20) {
      if ((getCurST(vict)) > 0) {
        if (blk > rand_number(1, 130)) {
          act("@C$N@W moves quickly and blocks your Malice Breaker!@n", FALSE,
              ch, 0, vict, TO_CHAR);
          act("@WYou move quickly and block @C$n's@W Malice Breaker!@n", FALSE,
              ch, 0, vict, TO_VICT);
          act("@C$N@W moves quickly and blocks @c$n's@W Malice Breaker!@n",
              FALSE, ch, 0, vict, TO_NOTVICT);
          pcost(ch, attperc, 0);
          pcost(vict, 0, GET_MAX_HIT(vict) / 500);
          ...
          act("@C$N@W manages to dodge your Malice Breaker, letting it slam "
              "into the surroundings!@n",
              FALSE, ch, 0, vict, TO_CHAR);
          act("@WYou dodge @C$n's@W Malice Breaker, letting it slam into the "
              "surroundings!@n",
              FALSE, ch, 0, vict, TO_VICT);
          act("@C$N@W manages to dodge @c$n's@W Malice Breaker, letting it "
              "slam into the surroundings!@n",
              FALSE, ch, 0, vict, TO_NOTVICT);
          send_to_room(char_room_get(vict),
                       "@wA bright explosion erupts from the impact!\r\n");
          ...
          dodge_ki(ch, vict, 0, 36, skill,
                   SKILL_MALICE); /* Effects on the room from dodging a ki
        attack Num 1: [ 0 for non-homing, 1 for homing ki attacks, 2 for guided
          ...
          act("@WYou can't believe it but your Malice Breaker misses, flying "
              "through the air harmlessly!@n",
              FALSE, ch, 0, vict, TO_CHAR);
          act("@C$n@W fires a Malice Breaker at you, but misses!@n ", FALSE, ch,
              0, vict, TO_VICT);
          act("@c$n@W fires a Malice Breaker at @C$N@W, but somehow misses!@n ",
              FALSE, ch, 0, vict, TO_NOTVICT);
        ...
        act("@WYou can't believe it but your Malice Breaker misses, flying "
            "through the air harmlessly!@n",
            FALSE, ch, 0, vict, TO_CHAR);
        act("@C$n@W fires a Malice Breaker at you, but misses!@n", FALSE, ch, 0,
            vict, TO_VICT);
        act("@c$n@W fires a Malice Breaker at @C$N@W, but somehow misses!@n",
            FALSE, ch, 0, vict, TO_NOTVICT);
        pcost(ch, attperc, 0);
      ...
      case 1:
        act("@WYou rush forward at @c$N@W, building ki into your arm. As you "
            "slam an open palm into $S chest, you send the charged energy into "
            "$S body. A few small explosions seem to hit across $S entire "
            "body, forcing $M to stumble back. Finally, you launch $M into the "
            "air, pointing a forefinger at $m like a pistol, and shout "
            "'@MM@ma@Dl@wi@Wce Br@we@Dak@me@Mr@W!' as a dark, violet explosion "
            "erupts at the epicenter of your first strike on @c$N@W's chest!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n @Wrushes forward at you, building ki into $s arm. As $e "
            "slams an open palm into your chest, $e sends the charged energy "
            "into your body. A few small explosions seem to hit across your "
            "entire body, forcing you to stumble back. Finally, @C$n@W "
            "launches you into the air, pointing a forefinger at your body "
            "like a pistol, and shouts '@MM@ma@Dl@wi@Wce Br@we@Dak@me@Mr@W!' "
            "as a dark, violet explosion erupts at the epicenter of $s first "
            "strike on your chest!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n@W rushes forward at $N@W, building ki into $s arm. As $e "
            "slam an open palm into @c$N's@W chest, $e sends the charged "
            "energy into $S body. A few small explosions seem to hit across "
            "@c$N's@W entire body, forcing $M to stumble back. Finally, @C$n@W "
            "launches $M into the air, pointing a forefinger at $m like a "
            "pistol, and shouts '@MM@ma@Dl@wi@Wce Br@we@Dak@me@Mr@W!' as a "
            "dark, violet explosion erupts at the epicenter of $s first strike "
            "on @c$N@W's chest!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        if (GET_BONUS(ch, BONUS_SOFT)) {
          dmg *= calc_critical(ch, 2);
      ...
      case 3:
        act("@WYou rush forward at @c$N@W, building ki into your arm. As you "
            "slam an open palm into $S head, you send the charged energy into "
            "$S body. A few small explosions seem to hit across $S entire "
            "body, forcing $M to stumble back. Finally, you launch $M into the "
            "air, pointing a forefinger at $m like a pistol, and shout "
            "'@MM@ma@Dl@wi@Wce Br@we@Dak@me@Mr@W!' as a dark, violet explosion "
            "erupts at the epicenter of your first strike on @c$N@W's head!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n @Wrushes forward at you, building ki into $s arm. As $e "
            "slams an open palm into your head, $e sends the charged energy "
            "into your body. A few small explosions seem to hit across your "
            "entire body, forcing you to stumble back. Finally, @C$n@W "
            "launches you into the air, pointing a forefinger at your body "
            "like a pistol, and shouts '@MM@ma@Dl@wi@Wce Br@we@Dak@me@Mr@W!' "
            "as a dark, violet explosion erupts at the epicenter of $s first "
            "strike on your head!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n@W rushes forward at $N@W, building ki into $s arm. As $e "
            "slam an open palm into @c$N's@W head, $e sends the charged energy "
            "into $S body. A few small explosions seem to hit across @c$N's@W "
            "entire body, forcing $M to stumble back. Finally, @C$n@W launches "
            "$M into the air, pointing a forefinger at $m like a pistol, and "
            "shouts '@MM@ma@Dl@wi@Wce Br@we@Dak@me@Mr@W!' as a dark, violet "
            "explosion erupts at the epicenter of $s first strike on @c$N@W's "
            "head!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        dmg *= calc_critical(ch, 0);
        hurt(0, 0, ch, vict, NULL, dmg, 1);
      ...
      case 4:
        act("@WYou rush forward at @c$N@W, building ki into your arm. As you "
            "slam an open palm into $S gut, you send the charged energy into "
            "$S body. A few small explosions seem to hit across $S entire "
            "body, forcing $M to stumble back. Finally, you launch $M into the "
            "air, pointing a forefinger at $m like a pistol, and shout "
            "'@MM@ma@Dl@wi@Wce Br@we@Dak@me@Mr@W!' as a dark, violet explosion "
            "erupts at the epicenter of your first strike on @c$N@W's gut!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n @Wrushes forward at you, building ki into $s arm. As $e "
            "slams an open palm into your gut, $e sends the charged energy "
            "into your body. A few small explosions seem to hit across your "
            "entire body, forcing you to stumble back. Finally, @C$n@W "
            "launches you into the air, pointing a forefinger at your body "
            "like a pistol, and shouts '@MM@ma@Dl@wi@Wce Br@we@Dak@me@Mr@W!' "
            "as a dark, violet explosion erupts at the epicenter of $s first "
            "strike on your gut!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n@W rushes forward at $N@W, building ki into $s arm. As $e "
            "slam an open palm into @c$N's@W gut, $e sends the charged energy "
            "into $S body. A few small explosions seem to hit across @c$N's@W "
            "entire body, forcing $M to stumble back. Finally, @C$n@W launches "
            "$M into the air, pointing a forefinger at $m like a pistol, and "
            "shouts '@MM@ma@Dl@wi@Wce Br@we@Dak@me@Mr@W!' as a dark, violet "
      ...
      case 5: /* Weak */
        act("@WYou rush forward at @c$N@W, building ki into your arm. As you "
            "slam an open palm into $S arm, you send the charged energy into "
            "$S body. A few small explosions seem to hit across $S entire "
            "body, forcing $M to stumble back. Finally, you launch $M into the "
            "air, pointing a forefinger at $m like a pistol, and shout "
            "'@MM@ma@Dl@wi@Wce Br@we@Dak@me@Mr@W!' as a dark, violet explosion "
            "erupts at the epicenter of your first strike on @c$N@W's arm!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n @Wrushes forward at you, building ki into $s arm. As $e "
            "slams an open palm into your arm, $e sends the charged energy "
            "into your body. A few small explosions seem to hit across your "
            "entire body, forcing you to stumble back. Finally, @C$n@W "
            "launches you into the air, pointing a forefinger at your body "
            "like a pistol, and shouts '@MM@ma@Dl@wi@Wce Br@we@Dak@me@Mr@W!' "
            "as a dark, violet explosion erupts at the epicenter of $s first "
            "strike on your arm!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n@W rushes forward at $N@W, building ki into $s arm. As $e "
            "slam an open palm into @c$N's@W arm, $e sends the charged energy "
            "into $S body. A few small explosions seem to hit across @c$N's@W "
            "entire body, forcing $M to stumble back. Finally, @C$n@W launches "
            "$M into the air, pointing a forefinger at $m like a pistol, and "
            "shouts '@MM@ma@Dl@wi@Wce Br@we@Dak@me@Mr@W!' as a dark, violet "
      ...
      case 6: /* Weak 2 */
        act("@WYou rush forward at @c$N@W, building ki into your arm. As you "
            "slam an open palm into $S leg, you send the charged energy into "
            "$S body. A few small explosions seem to hit across $S entire "
            "body, forcing $M to stumble back. Finally, you launch $M into the "
            "air, pointing a forefinger at $m like a pistol, and shout "
            "'@MM@ma@Dl@wi@Wce Br@we@Dak@me@Mr@W!' as a dark, violet explosion "
            "erupts at the epicenter of your first strike on @c$N@W's leg!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n @Wrushes forward at you, building ki into $s arm. As $e "
            "slams an open palm into your leg, $e sends the charged energy "
            "into your body. A few small explosions seem to hit across your "
            "entire body, forcing you to stumble back. Finally, @C$n@W "
            "launches you into the air, pointing a forefinger at your body "
            "like a pistol, and shouts '@MM@ma@Dl@wi@Wce Br@we@Dak@me@Mr@W!' "
            "as a dark, violet explosion erupts at the epicenter of $s first "
            "strike on your leg!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n@W rushes forward at $N@W, building ki into $s arm. As $e "
            "slam an open palm into @c$N's@W leg, $e sends the charged energy "
            "into $S body. A few small explosions seem to hit across @c$N's@W "
            "entire body, forcing $M to stumble back. Finally, @C$n@W launches "
            "$M into the air, pointing a forefinger at $m like a pistol, and "
            "shouts '@MM@ma@Dl@wi@Wce Br@we@Dak@me@Mr@W!' as a dark, violet "
...
ACMD(do_nova) {
  ...
  if (count <= 0) {
    ...
    handle_cooldown(ch, 6);
    if (skill < perc) {
      act("@WYou gather your charged energy and clench your upheld fists at "
          "either side of your body while crouching down. A hot glow of energy "
          "begins to form around your body before you lose your concentration "
          "and fail to create a @yS@Yt@Wa@wr @cN@Co@Wv@wa@W!@n",
          TRUE, ch, 0, 0, TO_CHAR);
      act("@C$n@W gathers $s charged energy and clenches $s upheld fists at "
          "either side of $s body while crouching down. A hot glow of energy "
          "begins to form around $s body before $e seems to lose $s "
          "concentration and fail to create a @yS@Yt@Wa@wr @cN@Co@Wv@wa@W!@n",
          TRUE, ch, 0, 0, TO_ROOM);
    ...
    act("@WYou gather your charged energy and clench your upheld fists at "
        "either side of your body while crouching down. A hot glow of energy "
        "begins to form around your body in the shape of a sphere! Suddenly a "
        "shockwave of heat and energy erupts out into the surrounding area as "
        "your glorious @yS@Yt@Wa@wr @cN@Co@Wv@wa@W is born!@n",
        TRUE, ch, 0, 0, TO_CHAR);
    act("@C$n@W gathers $s charged energy and clenches $s upheld fists at "
        "either side of $s body while crouching down. A hot glow of energy "
        "begins to form around $s body in the shape of a sphere! Suddenly a "
        "shockwave of heat and energy erupts out into the surrounding area as "
        "@C$n's@W glorious @yS@Yt@Wa@wr @cN@Co@Wv@wa@W is born!@n",
        TRUE, ch, 0, 0, TO_ROOM);
...
ACMD(do_seishou) {
  ...
  if (vict) {
    ...
    if (prob < perc - 20) {
      if ((getCurST(vict)) > 0) {
        if (dge > rand_number(1, 130)) {
          act("@C$N@W manages to dodge your Seishou Enko, letting it fly "
              "harmlessly by!@n",
              FALSE, ch, 0, vict, TO_CHAR);
          act("@WYou dodge @C$n's@W Seishou Enko, letting it fly harmlessly "
              "by!@n",
              FALSE, ch, 0, vict, TO_VICT);
          act("@C$N@W manages to dodge @c$n's@W Seishou Enko, letting it fly "
              "harmlessly by!@n",
              FALSE, ch, 0, vict, TO_NOTVICT);
          pcost(ch, attperc / 4, 0);
          hurt(0, 0, ch, vict, NULL, 0, 1);
          ...
          act("@WYou can't believe it but your Seishou Enko misses, flying "
              "through the air harmlessly!@n",
              FALSE, ch, 0, vict, TO_CHAR);
          act("@C$n@W fires a Seishou Enko at you, but misses!@n ", FALSE, ch,
              0, vict, TO_VICT);
          act("@c$n@W fires a Seishou Enko at @C$N@W, but somehow misses!@n ",
              FALSE, ch, 0, vict, TO_NOTVICT);
          pcost(ch, attperc / 4, 0);
          hurt(0, 0, ch, vict, NULL, 0, 1);
          return;
        ...
        act("@WYou can't believe it but your Seishou Enko misses, flying "
            "through the air harmlessly!@n",
            FALSE, ch, 0, vict, TO_CHAR);
        act("@C$n@W fires a Seishou Enko at you, but misses!@n", FALSE, ch, 0,
            vict, TO_VICT);
        act("@c$n@W fires a Seishou Enko at @C$N@W, but somehow misses!@n",
            FALSE, ch, 0, vict, TO_NOTVICT);
        pcost(ch, attperc / 4, 0);
      ...
      case 1:
        act("@WYou aim your mouth at @C$N@W and focus your charged ki. In an "
            "instant you fire a large @Rr@re@Rd@W @rS@Re@Wi@ws@rh@Ro@Wu "
            "@wE@rn@Rk@Wo at $M! Almost instantly it blasts into $S body with "
            "searing heat!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n @Waims $s mouth at YOU and seems to focus $s ki. In an "
            "instant $e fires a large @Rr@re@Rd@W @rS@Re@Wi@ws@rh@Ro@Wu "
            "@wE@rn@Rk@Wo at YOU! Almost instantly it blasts into YOUR body "
            "with searing heat!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n @Waims $s mouth at @c$N@W and seems to focus $s ki. In an "
            "instant $e fires a large @Rr@re@Rd@W @rS@Re@Wi@ws@rh@Ro@Wu "
            "@wE@rn@Rk@Wo at $M! Almost instantly it blasts into $S body with "
            "searing heat!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
      ...
      case 4: /* Critical */
        act("@WYou aim your mouth at @C$N@W and focus your charged ki. In an "
            "instant you fire a large @Rr@re@Rd@W @rS@Re@Wi@ws@rh@Ro@Wu "
            "@wE@rn@Rk@Wo at $M! Almost instantly it blasts into $S head with "
            "searing heat!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n @Waims $s mouth at YOU and seems to focus $s ki. In an "
            "instant $e fires a large @Rr@re@Rd@W @rS@Re@Wi@ws@rh@Ro@Wu "
            "@wE@rn@Rk@Wo at YOU! Almost instantly it blasts into YOUR head "
            "with searing heat!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n @Waims $s mouth at @c$N@W and seems to focus $s ki. In an "
            "instant $e fires a large @Rr@re@Rd@W @rS@Re@Wi@ws@rh@Ro@Wu "
      ...
      case 5:
        act("@WYou aim your mouth at @C$N@W and focus your charged ki. In an "
            "instant you fire a large @Rr@re@Rd@W @rS@Re@Wi@ws@rh@Ro@Wu "
            "@wE@rn@Rk@Wo at $M! Almost instantly it blasts into $S gut with "
            "searing heat!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n @Waims $s mouth at YOU and seems to focus $s ki. In an "
            "instant $e fires a large @Rr@re@Rd@W @rS@Re@Wi@ws@rh@Ro@Wu "
            "@wE@rn@Rk@Wo at YOU! Almost instantly it blasts into YOUR gut "
            "with searing heat!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n @Waims $s mouth at @c$N@W and seems to focus $s ki. In an "
            "instant $e fires a large @Rr@re@Rd@W @rS@Re@Wi@ws@rh@Ro@Wu "
      ...
      case 6: /* Weak */
        act("@WYou aim your mouth at @C$N@W and focus your charged ki. In an "
            "instant you fire a large @Rr@re@Rd@W @rS@Re@Wi@ws@rh@Ro@Wu "
            "@wE@rn@Rk@Wo at $M! Almost instantly it blasts into $S arm with "
            "searing heat!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n @Waims $s mouth at YOU and seems to focus $s ki. In an "
            "instant $e fires a large @Rr@re@Rd@W @rS@Re@Wi@ws@rh@Ro@Wu "
            "@wE@rn@Rk@Wo at YOU! Almost instantly it blasts into YOUR arm "
            "with searing heat!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n @Waims $s mouth at @c$N@W and seems to focus $s ki. In an "
            "instant $e fires a large @Rr@re@Rd@W @rS@Re@Wi@ws@rh@Ro@Wu "
      ...
      case 7: /* Weak 2 */
        act("@WYou aim your mouth at @C$N@W and focus your charged ki. In an "
            "instant you fire a large @Rr@re@Rd@W @rS@Re@Wi@ws@rh@Ro@Wu "
            "@wE@rn@Rk@Wo at $M! Almost instantly it blasts into $S leg with "
            "searing heat!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n @Waims $s mouth at YOU and seems to focus $s ki. In an "
            "instant $e fires a large @Rr@re@Rd@W @rS@Re@Wi@ws@rh@Ro@Wu "
            "@wE@rn@Rk@Wo at YOU! Almost instantly it blasts into YOUR leg "
            "with searing heat!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n @Waims $s mouth at @c$N@W and seems to focus $s ki. In an "
            "instant $e fires a large @Rr@re@Rd@W @rS@Re@Wi@ws@rh@Ro@Wu "
...
ACMD(do_razor) {
  ...
  if (vict) {
    if (IS_ANDROID(vict)) {
      send_to_char(ch, "There is not a necessary amount of water in cybernetic "
                       "creatures.\r\n");
      return;
    }
    if (!can_kill(ch, vict, NULL, 1)) {
    ...
    if (prob < perc - 20) {
      if ((getCurST(vict)) > 0) {
        if (dge > rand_number(1, 130)) {
          act("@C$N@W manages to dodge your Water Razor, letting it fly "
              "harmlessly by!@n",
              FALSE, ch, 0, vict, TO_CHAR);
          act("@WYou dodge @C$n's@W Water Razor, letting it fly harmlessly "
              "by!@n",
              FALSE, ch, 0, vict, TO_VICT);
          act("@C$N@W manages to dodge @c$n's@W Water Razor, letting it fly "
              "harmlessly by!@n",
              FALSE, ch, 0, vict, TO_NOTVICT);
          pcost(ch, attperc, 0);
          hurt(0, 0, ch, vict, NULL, 0, 1);
          ...
          act("@WYou can't believe it but your Water Razor misses, flying "
              "through the air harmlessly!@n",
              FALSE, ch, 0, vict, TO_CHAR);
          act("@C$n@W fires a Water Razor at you, but misses!@n ", FALSE, ch, 0,
              vict, TO_VICT);
          act("@c$n@W fires a Water Razor at @C$N@W, but somehow misses!@n ",
              FALSE, ch, 0, vict, TO_NOTVICT);
          pcost(ch, attperc, 0);
          hurt(0, 0, ch, vict, NULL, 0, 1);
          return;
      ...
      switch (hitspot) {
      case 1:
        act("@WYou raise your hand toward @c$N@W with the palm open as if you "
            "are ready to grab the air between the two of you. You then focus "
            "your ki into $S body and close your hand in an instant! The "
            "@Bwater@W in $S body instantly takes the shape of millions of "
            "microscopic @Dblades@W that cut up $S insides!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n@W raises $s hand toward YOU with the palm open as if $e is "
            "ready to grab the air between the two of you. $e then focus $s ki "
            "into YOUR body and close $s hand in an instant! The @Bwater@W in "
            "your body instantly takes the shape of millions of microscopic "
            "@Dblades@W that cut up YOUR insides!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n@W raises $s hand toward @c$N@W with the palm open as if $e "
            "is ready to grab the air between the two of them. $e then focus "
            "$s ki into @c$N's@W body and close $s hand in an instant! The "
            "@Bwater@W in @c$N's@W body instantly takes the shape of millions "
            "of microscopic @Dblades@W that cut up $S insides!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        if (GET_BONUS(ch, BONUS_SOFT)) {
          dmg *= calc_critical(ch, 2);
        }
      ...
      case 2: /* Critical */
        act("@WYou raise your hand toward @c$N@W with the palm open as if you "
            ...
            "your ki into $S body and close your hand in an instant! The "
            "@Bwater@W in $S body instantly takes the shape of millions of "
            "microscopic @Dblades@W that cut up $S insides! Blood sprays out "
            "in a mist from every pore of $S body!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n@W raises $s hand toward YOU with the palm open as if $e is "
            "ready to grab the air between the two of you. $e then focus $s ki "
            "into YOUR body and close $s hand in an instant! The @Bwater@W in "
            "your body instantly takes the shape of millions of microscopic "
            "@Dblades@W that cut up YOUR insides! Blood sprays out of your "
            "pores into a fine mist!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n@W raises $s hand toward @c$N@W with the palm open as if $e "
            "is ready to grab the air between the two of them. $e then focus "
            "$s ki into @c$N's@W body and close $s hand in an instant! The "
            "@Bwater@W in @c$N's@W body instantly takes the shape of millions "
            "of microscopic @Dblades@W that cut up $S insides! Blood sprays "
            "out of $S pores into a fine mist!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        dmg *= calc_critical(ch, 0);
        hurt(0, 0, ch, vict, NULL, dmg, 1);
        break;
      ...
      if (vict) {
        ...
        if ((!IS_NPC(vict) && !AFF_FLAGGED(vict, AFF_SPIRIT)) ||
            (IS_NPC(vict) && GET_HIT(vict) > 0)) {
          decCurKI(vict, reduction);
          decCurST(vict, reduction);
        }
      }
      return;
    }
    ...
    send_to_char(
        ch, "You can not hurt an inanimate object with this technique.\r\n");
    return;
  } else {
    send_to_char(ch, "Error! Please report.\r\n");
    return;
  ...
  if (vict) {
    ...
    if (!tech_handle_zanzoken(ch, vict, "attack")) {
      ...
      if (GET_SKILL(ch, SKILL_WSPIKE) >= 100) {
        incCurKI(ch, (getMaxKI(ch) * attperc) * .3);
    ...
    if (prob < perc - 20) {
      if ((getCurST(vict)) > 0) {
        if (blk > rand_number(1, 130)) {
          act("@C$N@W moves quickly and blocks your water spikes!@n", FALSE, ch,
              0, vict, TO_CHAR);
          act("@WYou move quickly and block @C$n's@W water spikes!@n", FALSE,
              ch, 0, vict, TO_VICT);
          act("@C$N@W moves quickly and blocks @c$n's@W water spikes!@n", FALSE,
              ch, 0, vict, TO_NOTVICT);
          if (GET_SKILL_PERF(ch, SKILL_WSPIKE) == 3 && attperc > minimum) {
            pcost(ch, attperc - 0.05, 0);
          } else {
          ...
          act("@C$N@W manages to dodge your water spikes, letting them slam "
              "into the surroundings!@n",
              FALSE, ch, 0, vict, TO_CHAR);
          act("@WYou dodge @C$n's@W water spikes, letting them slam into the "
              "surroundings!@n",
              FALSE, ch, 0, vict, TO_VICT);
          act("@C$N@W manages to dodge @c$n's@W water spikes, letting them "
              "slam into the surroundings!@n",
              FALSE, ch, 0, vict, TO_NOTVICT);
          send_to_room(char_room_get(vict),
                       "@wA bright explosion erupts from the impact!\r\n");

          dodge_ki(ch, vict, 0, 43, skill,
                   SKILL_WSPIKE); /* Effects on the room from dodging a ki
          ...
          act("@WYou can't believe it but your water spikes miss, flying "
              "through the air harmlessly!@n",
              FALSE, ch, 0, vict, TO_CHAR);
          act("@C$n@W fire water spikes at you, but misses!@n ", FALSE, ch, 0,
              vict, TO_VICT);
          act("@c$n@W fire water spikes at @C$N@W, but somehow misses!@n ",
              FALSE, ch, 0, vict, TO_NOTVICT);
          if (GET_SKILL_PERF(ch, SKILL_WSPIKE) == 3 && attperc > minimum) {
            pcost(ch, attperc - 0.05, 0);
          } else {
        ...
        act("@WYou can't believe it but your water spikes miss, flying through "
            "the air harmlessly!@n",
            FALSE, ch, 0, vict, TO_CHAR);
        act("@C$n@W fires water spikes at you, but misses!@n", FALSE, ch, 0,
            vict, TO_VICT);
        act("@c$n@W fires water spikes at @C$N@W, but somehow misses!@n", FALSE,
            ch, 0, vict, TO_NOTVICT);
        if (GET_SKILL_PERF(ch, SKILL_WSPIKE) == 3 && attperc > minimum) {
          pcost(ch, attperc - 0.05, 0);
        } else {
      ...
      switch (hitspot) {
      case 1:
        act("@CYou slam both your hands together in front of you, palms flat. "
            "As you pull them apart ki flows from your palms and forms into a "
            "giant ball of water. You raise your hand above your head with the "
            "ball of water. You command the water to form several sharp spikes "
            "which freeze upon forming. The spikes then launch at @R$N@C and "
            "slam into $S chest!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@c$n@C slams both $s hands together in front of $mself, palms "
            "flat. As $e pulls them apart ki flows from the palms and forms "
            "into a giant ball of water. Then $e raises $s hand above $s head "
            "with the ball of water. The water forms several sharp spikes "
            "which freeze instantly as they take shape. The spikes then launch "
            "at @RYOU@C and slam into YOUR chest!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@c$n@C slams both $s hands together in front of $mself, palms "
            "flat. As $e pulls them apart ki flows from the palms and forms "
            "into a giant ball of water. Then $e raises $s hand above $s head "
            "with the ball of water. The water forms several sharp spikes "
            "which freeze instantly as they take shape. The spikes then launch "
            "at @R$N@C and slam into $s chest!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        if (GET_BONUS(ch, BONUS_SOFT)) {
          dmg *= calc_critical(ch, 2);
        }
      ...
      case 2: /* Critical */
        ...
        act("@c$n@C slams both $s hands together in front of $mself, palms "
            ...
            "with the ball of water. The water forms several sharp spikes "
            "which freeze instantly as they take shape. The spikes then launch "
            "at @RYOU@C and slam into YOUR head!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@c$n@C slams both $s hands together in front of $mself, palms "
            "flat. As $e pulls them apart ki flows from the palms and forms "
            "into a giant ball of water. Then $e raises $s hand above $s head "
            "with the ball of water. The water forms several sharp spikes "
            "which freeze instantly as they take shape. The spikes then launch "
            "at @R$N@C and slam into $s head!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        dmg *= calc_critical(ch, 0);
        if (GET_SKILL_PERF(ch, SKILL_WSPIKE) == 3) {
          WAIT_STATE(ch, PULSE_3SEC);
      ...
      case 3:
        ...
        act("@c$n@C slams both $s hands together in front of $mself, palms "
            ...
            "with the ball of water. The water forms several sharp spikes "
            "which freeze instantly as they take shape. The spikes then launch "
            "at @RYOU@C and slam into YOUR body!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@c$n@C slams both $s hands together in front of $mself, palms "
            "flat. As $e pulls them apart ki flows from the palms and forms "
            "into a giant ball of water. Then $e raises $s hand above $s head "
            "with the ball of water. The water forms several sharp spikes "
            "which freeze instantly as they take shape. The spikes then launch "
            "at @R$N@C and slam into $s body!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        if (GET_BONUS(ch, BONUS_SOFT)) {
          dmg *= calc_critical(ch, 2);
        }
      ...
      case 4: /* Weak */
        ...
        act("@c$n@C slams both $s hands together in front of $mself, palms "
            ...
            "with the ball of water. The water forms several sharp spikes "
            "which freeze instantly as they take shape. The spikes then launch "
            "at @RYOU@C and slam into YOUR arm!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@c$n@C slams both $s hands together in front of $mself, palms "
            "flat. As $e pulls them apart ki flows from the palms and forms "
            "into a giant ball of water. Then $e raises $s hand above $s head "
            "with the ball of water. The water forms several sharp spikes "
            "which freeze instantly as they take shape. The spikes then launch "
            "at @R$N@C and slam into $s arm!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        dam_eq_loc(vict, 1);
      ...
      case 5: /* Weak 2 */
        ...
        act("@c$n@C slams both $s hands together in front of $mself, palms "
            ...
            "with the ball of water. The water forms several sharp spikes "
            "which freeze instantly as they take shape. The spikes then launch "
            "at @RYOU@C and slam into YOUR leg!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@c$n@C slams both $s hands together in front of $mself, palms "
            "flat. As $e pulls them apart ki flows from the palms and forms "
            "into a giant ball of water. Then $e raises $s hand above $s head "
            "with the ball of water. The water forms several sharp spikes "
            "which freeze instantly as they take shape. The spikes then launch "
            "at @R$N@C and slam into $s leg!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        dam_eq_loc(vict, 2);
        if (GET_SKILL_PERF(ch, SKILL_WSPIKE) == 3) {
          WAIT_STATE(ch, PULSE_3SEC);
...
ACMD(do_koteiru) {
  ...
  if (vict) {
    ...
    if (prob < perc - 20) {
      if ((getCurST(vict)) > 0) {
        if (dge > rand_number(1, 130)) {
          act("@C$N@W manages to dodge your Koteiru Bakuha, letting it fly "
              "harmlessly by!@n",
              FALSE, ch, 0, vict, TO_CHAR);
          act("@WYou dodge @C$n's@W Koteiru Bakuha, letting it fly harmlessly "
              "by!@n",
              FALSE, ch, 0, vict, TO_VICT);
          act("@C$N@W manages to dodge @c$n's@W Koteiru Bakuha, letting it fly "
              "harmlessly by!@n",
              FALSE, ch, 0, vict, TO_NOTVICT);
          pcost(ch, attperc, 0);
          hurt(0, 0, ch, vict, NULL, 0, 1);
          ...
          act("@WYou can't believe it but your Koteiru Bakuha misses, flying "
              "through the air harmlessly!@n",
              FALSE, ch, 0, vict, TO_CHAR);
          act("@C$n@W fires a Koteiru Bakuha at you, but misses!@n ", FALSE, ch,
              0, vict, TO_VICT);
          act("@c$n@W fires a Koteiru Bakuha at @C$N@W, but somehow misses!@n ",
              FALSE, ch, 0, vict, TO_NOTVICT);
          pcost(ch, attperc, 0);
          hurt(0, 0, ch, vict, NULL, 0, 1);
          return;
        ...
        act("@WYou can't believe it but your Koteiru Bakuha misses, flying "
            "through the air harmlessly!@n",
            FALSE, ch, 0, vict, TO_CHAR);
        act("@C$n@W fires a Koteiru Bakuha at you, but misses!@n", FALSE, ch, 0,
            vict, TO_VICT);
        act("@c$n@W fires a Koteiru Bakuha at @C$N@W, but somehow misses!@n",
            FALSE, ch, 0, vict, TO_NOTVICT);
        pcost(ch, attperc, 0);
      ...
      switch (hitspot) {
      case 1:
        act("@CYou hold your hands outstretched in front of your body and with "
            "your ki begin to create turbulant waters that hover around your "
            "body. You begin a sort of dance as you control the water more and "
            "more until you have created a huge floating wave. In an instant "
            "you swing the wave at @W$N@C! As the wave slams into $S chest it "
            "freezes solid around $M!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@c$n@C holds $s hands outstretched in front of $s body and with "
            "$s ki begins to create turbulant waters that hover around $s "
            "body. @c$n@C begins a sort of dance as $e controls the water more "
            "and more until $e has created a huge floating wave. In an instant "
            "$e swings the wave at YOU! As the wave slams into YOUR chest it "
            "freezes solid around YOU!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@c$n@C holds $s hands outstretched in front of $s body and with "
            "$s ki begins to create turbulant waters that hover around $s "
            "body. @c$n@C begins a sort of dance as $e controls the water more "
            "and more until $e has created a huge floating wave. In an instant "
            "$e swings the wave at @W$N@C! As the wave slams into $S chest it "
            "freezes solid around @W$N@C!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        if (GET_BONUS(ch, BONUS_SOFT)) {
          dmg *= calc_critical(ch, 2);
        }
      ...
      case 2: /* Critical */
        act("@CYou hold your hands outstretched in front of your body and with "
            ...
            "body. You begin a sort of dance as you control the water more and "
            "more until you have created a huge floating wave. In an instant "
            "you swing the wave at @W$N@C! As the wave slams into $S head it "
            "freezes solid around $M!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@c$n@C holds $s hands outstretched in front of $s body and with "
            "$s ki begins to create turbulant waters that hover around $s "
            "body. @c$n@C begins a sort of dance as $e controls the water more "
            "and more until $e has created a huge floating wave. In an instant "
            "$e swings the wave at YOU! As the wave slams into YOUR head it "
            "freezes solid around YOU!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@c$n@C holds $s hands outstretched in front of $s body and with "
            "$s ki begins to create turbulant waters that hover around $s "
            "body. @c$n@C begins a sort of dance as $e controls the water more "
            "and more until $e has created a huge floating wave. In an instant "
            "$e swings the wave at @W$N@C! As the wave slams into $S head it "
            "freezes solid around @W$N@C!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        dmg *= calc_critical(ch, 0);
        hurt(0, 0, ch, vict, NULL, dmg, 1);
      ...
      case 3:
        act("@CYou hold your hands outstretched in front of your body and with "
            ...
            "body. You begin a sort of dance as you control the water more and "
            "more until you have created a huge floating wave. In an instant "
            "you swing the wave at @W$N@C! As the wave slams into $S gut it "
            "freezes solid around $M!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@c$n@C holds $s hands outstretched in front of $s body and with "
            "$s ki begins to create turbulant waters that hover around $s "
            "body. @c$n@C begins a sort of dance as $e controls the water more "
            "and more until $e has created a huge floating wave. In an instant "
            "$e swings the wave at YOU! As the wave slams into YOUR gut it "
            "freezes solid around YOU!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@c$n@C holds $s hands outstretched in front of $s body and with "
            "$s ki begins to create turbulant waters that hover around $s "
            "body. @c$n@C begins a sort of dance as $e controls the water more "
            "and more until $e has created a huge floating wave. In an instant "
            "$e swings the wave at @W$N@C! As the wave slams into $S gut it "
            "freezes solid around @W$N@C!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        if (GET_BONUS(ch, BONUS_SOFT)) {
          dmg *= calc_critical(ch, 2);
      ...
      case 4: /* Weak */
        act("@CYou hold your hands outstretched in front of your body and with "
            ...
            "body. You begin a sort of dance as you control the water more and "
            "more until you have created a huge floating wave. In an instant "
            "you swing the wave at @W$N@C! As the wave slams into $S arm it "
            "freezes solid around $M!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@c$n@C holds $s hands outstretched in front of $s body and with "
            "$s ki begins to create turbulant waters that hover around $s "
            "body. @c$n@C begins a sort of dance as $e controls the water more "
            "and more until $e has created a huge floating wave. In an instant "
            "$e swings the wave at YOU! As the wave slams into YOUR arm it "
            "freezes solid around YOU!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@c$n@C holds $s hands outstretched in front of $s body and with "
            "$s ki begins to create turbulant waters that hover around $s "
            "body. @c$n@C begins a sort of dance as $e controls the water more "
            "and more until $e has created a huge floating wave. In an instant "
            "$e swings the wave at @W$N@C! As the wave slams into $S arm it "
            "freezes solid around @W$N@C!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        dmg *= calc_critical(ch, 1);
        dam_eq_loc(vict, 1);
      ...
      case 5: /* Weak 2 */
        act("@CYou hold your hands outstretched in front of your body and with "
            ...
            "body. You begin a sort of dance as you control the water more and "
            "more until you have created a huge floating wave. In an instant "
            "you swing the wave at @W$N@C! As the wave slams into $S leg it "
            "freezes solid around $M!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@c$n@C holds $s hands outstretched in front of $s body and with "
            "$s ki begins to create turbulant waters that hover around $s "
            "body. @c$n@C begins a sort of dance as $e controls the water more "
            "and more until $e has created a huge floating wave. In an instant "
            "$e swings the wave at YOU! As the wave slams into YOUR leg it "
            "freezes solid around YOU!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@c$n@C holds $s hands outstretched in front of $s body and with "
            "$s ki begins to create turbulant waters that hover around $s "
            "body. @c$n@C begins a sort of dance as $e controls the water more "
            "and more until $e has created a huge floating wave. In an instant "
            "$e swings the wave at @W$N@C! As the wave slams into $S leg it "
            "freezes solid around @W$N@C!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        dmg *= calc_critical(ch, 1);
        dam_eq_loc(vict, 2);
      ...
      if (vict) {
        if (GET_HIT(vict) > 1) {
          if (rand_number(1, 4) == 1 && !AFF_FLAGGED(vict, AFF_FROZEN) &&
              !IS_DEMON(vict)) {
...
ACMD(do_hspiral) {
  ...
  if (vict) {
    ...
    if (prob < perc - 20) {
      if ((getCurST(vict)) > 0) {
        if (dge > rand_number(1, 130)) {
          act("@C$N@W manages to dodge your Hell Spiral, letting it fly "
              "harmlessly by!@n",
              FALSE, ch, 0, vict, TO_CHAR);
          act("@WYou dodge @C$n's@W Hell Spiral, letting it fly harmlessly "
              "by!@n",
              FALSE, ch, 0, vict, TO_VICT);
          act("@C$N@W manages to dodge @c$n's@W Hell Spiral, letting it fly "
              "harmlessly by!@n",
              FALSE, ch, 0, vict, TO_NOTVICT);
          pcost(ch, attperc, 0);
          hurt(0, 0, ch, vict, NULL, 0, 1);
          ...
          act("@WYou can't believe it but your Hell Spiral misses, flying "
              "through the air harmlessly!@n",
              FALSE, ch, 0, vict, TO_CHAR);
          act("@C$n@W fires a Hell Spiral at you, but misses!@n ", FALSE, ch, 0,
              vict, TO_VICT);
          act("@c$n@W fires a Hell Spiral at @C$N@W, but somehow misses!@n ",
              FALSE, ch, 0, vict, TO_NOTVICT);
          pcost(ch, attperc, 0);
          hurt(0, 0, ch, vict, NULL, 0, 1);
          return;
      ...
      switch (hitspot) {
      case 1:
        act("@WYou hold out your hand, palm upward, while looking toward "
            "@C$N@W and grinning as @Rred@W energy begins to pool in the "
            "center of your palm. As the large orb of energy swells to about "
            "three feet in diameter you move your hand away! You quickly punch "
            "the ball of energy and send it flying into @C$N's@W chest where "
            "it @re@Rx@Dp@rl@Ro@Dd@re@Rs@W in a flash of light!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n @Wholds out $s hand, palm upward, while looking toward YOU "
            "and grinning as @Rred@W energy begins to pool in the center of $s "
            "palm. As the large orb of energy swells to about three feet in "
            "diameter $e moves $s hand away! Then $e quickly punches the ball "
            "of energy and sends it flying into YOUR chest where it "
            "@re@Rx@Dp@rl@Ro@Dd@re@Rs@W in a flash of light!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n @Wholds out $s hand, palm upward, while looking toward "
            "@c$N@W and grinning as @Rred@W energy begins to pool in the "
            "center of $s palm. As the large orb of energy swells to about "
            "three feet in diameter $e moves $s hand away! Then $e quickly "
            "punches the ball of energy and sends it flying into @c$N's@W "
            "chest where it @re@Rx@Dp@rl@Ro@Dd@re@Rs@W in a flash of light!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        if (GET_BONUS(ch, BONUS_SOFT)) {
          dmg *= calc_critical(ch, 2);
        }
      ...
      case 2: /* Critical */
        act("@WYou hold out your hand, palm upward, while looking toward "
            ...
            "center of your palm. As the large orb of energy swells to about "
            "three feet in diameter you move your hand away! You quickly punch "
            "the ball of energy and send it flying into @C$N's@W head where it "
            "@re@Rx@Dp@rl@Ro@Dd@re@Rs@W in a flash of light!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n @Wholds out $s hand, palm upward, while looking toward YOU "
            "and grinning as @Rred@W energy begins to pool in the center of $s "
            "palm. As the large orb of energy swells to about three feet in "
            "diameter $e moves $s hand away! Then $e quickly punches the ball "
            "of energy and sends it flying into YOUR head where it "
            "@re@Rx@Dp@rl@Ro@Dd@re@Rs@W in a flash of light!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n @Wholds out $s hand, palm upward, while looking toward "
            "@c$N@W and grinning as @Rred@W energy begins to pool in the "
            "center of $s palm. As the large orb of energy swells to about "
            "three feet in diameter $e moves $s hand away! Then $e quickly "
            "punches the ball of energy and sends it flying into @c$N's@W head "
            "where it @re@Rx@Dp@rl@Ro@Dd@re@Rs@W in a flash of light!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        dmg *= calc_critical(ch, 0);
        hurt(0, 0, ch, vict, NULL, dmg, 1);
        dam_eq_loc(vict, 3);
      ...
      case 3:
        act("@WYou hold out your hand, palm upward, while looking toward "
            ...
            "center of your palm. As the large orb of energy swells to about "
            "three feet in diameter you move your hand away! You quickly punch "
            "the ball of energy and send it flying into @C$N's@W body where it "
            "@re@Rx@Dp@rl@Ro@Dd@re@Rs@W in a flash of light!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n @Wholds out $s hand, palm upward, while looking toward YOU "
            "and grinning as @Rred@W energy begins to pool in the center of $s "
            "palm. As the large orb of energy swells to about three feet in "
            "diameter $e moves $s hand away! Then $e quickly punches the ball "
            "of energy and sends it flying into YOUR body where it "
            "@re@Rx@Dp@rl@Ro@Dd@re@Rs@W in a flash of light!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n @Wholds out $s hand, palm upward, while looking toward "
            "@c$N@W and grinning as @Rred@W energy begins to pool in the "
            "center of $s palm. As the large orb of energy swells to about "
            "three feet in diameter $e moves $s hand away! Then $e quickly "
            "punches the ball of energy and sends it flying into @c$N's@W body "
            "where it @re@Rx@Dp@rl@Ro@Dd@re@Rs@W in a flash of light!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        if (GET_BONUS(ch, BONUS_SOFT)) {
          dmg *= calc_critical(ch, 2);
      ...
      case 4: /* Weak */
        act("@WYou hold out your hand, palm upward, while looking toward "
            ...
            "center of your palm. As the large orb of energy swells to about "
            "three feet in diameter you move your hand away! You quickly punch "
            "the ball of energy and send it flying into @C$N's@W arm where it "
            "@re@Rx@Dp@rl@Ro@Dd@re@Rs@W in a flash of light!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n @Wholds out $s hand, palm upward, while looking toward YOU "
            "and grinning as @Rred@W energy begins to pool in the center of $s "
            "palm. As the large orb of energy swells to about three feet in "
            "diameter $e moves $s hand away! Then $e quickly punches the ball "
            "of energy and sends it flying into YOUR arm where it "
            "@re@Rx@Dp@rl@Ro@Dd@re@Rs@W in a flash of light!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n @Wholds out $s hand, palm upward, while looking toward "
            "@c$N@W and grinning as @Rred@W energy begins to pool in the "
            "center of $s palm. As the large orb of energy swells to about "
            "three feet in diameter $e moves $s hand away! Then $e quickly "
            "punches the ball of energy and sends it flying into @c$N's@W arm "
            "where it @re@Rx@Dp@rl@Ro@Dd@re@Rs@W in a flash of light!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        dmg *= calc_critical(ch, 1);
        dam_eq_loc(vict, 1);
      ...
      case 5: /* Weak 2 */
        act("@WYou hold out your hand, palm upward, while looking toward "
            ...
            "center of your palm. As the large orb of energy swells to about "
            "three feet in diameter you move your hand away! You quickly punch "
            "the ball of energy and send it flying into @C$N's@W leg where it "
            "@re@Rx@Dp@rl@Ro@Dd@re@Rs@W in a flash of light!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n @Wholds out $s hand, palm upward, while looking toward YOU "
            "and grinning as @Rred@W energy begins to pool in the center of $s "
            "palm. As the large orb of energy swells to about three feet in "
            "diameter $e moves $s hand away! Then $e quickly punches the ball "
            "of energy and sends it flying into YOUR leg where it "
            "@re@Rx@Dp@rl@Ro@Dd@re@Rs@W in a flash of light!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n @Wholds out $s hand, palm upward, while looking toward "
            "@c$N@W and grinning as @Rred@W energy begins to pool in the "
            "center of $s palm. As the large orb of energy swells to about "
            "three feet in diameter $e moves $s hand away! Then $e quickly "
            "punches the ball of energy and sends it flying into @c$N's@W leg "
            "where it @re@Rx@Dp@rl@Ro@Dd@re@Rs@W in a flash of light!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        dmg *= calc_critical(ch, 1);
        dam_eq_loc(vict, 2);
...
ACMD(do_breaker) {
  ...
  if (vict) {
    ...
    if (prob < perc - 20) {
      if ((getCurST(vict)) > 0) {
        if (blk > rand_number(1, 130)) {
          act("@C$N@W moves quickly and blocks your Star Breaker!@n", FALSE, ch,
              0, vict, TO_CHAR);
          act("@WYou move quickly and block @C$n's@W Star Breaker!@n", FALSE,
              ch, 0, vict, TO_VICT);
          act("@C$N@W moves quickly and blocks @c$n's@W Star Breaker!@n", FALSE,
              ch, 0, vict, TO_NOTVICT);
          pcost(ch, attperc, 0);
          dmg = damtype(ch, 10, skill, attperc);
          dmg /= 4;
          ...
          act("@C$N@W manages to dodge your Star Breaker, letting it slam into "
              "the surroundings!@n",
              FALSE, ch, 0, vict, TO_CHAR);
          act("@WYou dodge @C$n's@W Star Breaker, letting it slam into the "
              "surroundings!@n",
              FALSE, ch, 0, vict, TO_VICT);
          act("@C$N@W manages to dodge @c$n's@W Star Breaker, letting it slam "
              "into the surroundings!@n",
              FALSE, ch, 0, vict, TO_NOTVICT);
          send_to_room(char_room_get(vict),
                       "@wA bright explosion erupts from the impact!\r\n");

          dodge_ki(ch, vict, 0, 46, skill,
                   SKILL_BREAKER); /* Effects on the room from dodging a ki
        attack Num 1: [ 0 for non-homing, 1 for homing ki attacks, 2 for guided
        ] Num 2: [ Number of attack for damtype ]*/
          ...
          act("@WYou can't believe it but your Star Breaker misses, flying "
              "through the air harmlessly!@n",
              FALSE, ch, 0, vict, TO_CHAR);
          act("@C$n@W fires a Star Breaker at you, but misses!@n ", FALSE, ch,
              0, vict, TO_VICT);
          act("@c$n@W fires a Star Breaker at @C$N@W, but somehow misses!@n ",
              FALSE, ch, 0, vict, TO_NOTVICT);
          pcost(ch, attperc, 0);
          hurt(0, 0, ch, vict, NULL, 0, 1);
          return;
        ...
        act("@WYou can't believe it but your Star Breaker misses, flying "
            "through the air harmlessly!@n",
            FALSE, ch, 0, vict, TO_CHAR);
        act("@C$n@W fires a Star Breaker at you, but misses!@n", FALSE, ch, 0,
            vict, TO_VICT);
        act("@c$n@W fires a Star Breaker at @C$N@W, but somehow misses!@n",
            FALSE, ch, 0, vict, TO_NOTVICT);
        pcost(ch, attperc, 0);
      ...
      switch (hitspot) {
      case 1:
        act("@WYou raise your right hand above your head with it slightly "
            "cupped. Dark @rred@W energy from the Eldritch Star begins to pool "
            "there and form a growing orb of energy. At the same time "
            "@mpurple@W arcs of electricity formed by your ki flows up your "
            "left arm as you raise it. You slam both of your hands together, "
            "combining the energy, and then toss your @YS@yta@Yr "
            "@rB@Rr@De@ra@Rk@De@rr@W at @c$N@W! It engulfs $S chest!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n@W raises $s right hand above $s head with it slightly "
            "cupped. Dark @rred@W energy begins to pool there and form a "
            "growing orb of energy. At the same time @mpurple@W arcs of "
            "electricity formed by $s ki flows up $s left arm as $e raises it. "
            "Suddenly $e slams both of $s hands together, combining the "
            "energy, and then toss a @YS@yta@Yr @rB@Rr@De@ra@Rk@De@rr@W at "
            "YOU! It engulfs your chest!@n",
            TRUE, ch, 0, vict, TO_VICT);
        act("@C$n@W raises $s right hand above $s head with it slightly "
            "cupped. Dark @rred@W energy begins to pool there and form a "
            "growing orb of energy. At the same time @mpurple@W arcs of "
            "electricity formed by $s ki flows up $s left arm as $e raises it. "
            "Suddenly $e slams both of $s hands together, combining the "
            "energy, and then tosses a @YS@yta@Yr @rB@Rr@De@ra@Rk@De@rr@W at "
            "@c$N@W! It engulfs $S chest!@n",
            TRUE, ch, 0, vict, TO_NOTVICT);
        if (GET_BONUS(ch, BONUS_SOFT)) {
          dmg *= calc_critical(ch, 2);
        }
      ...
      case 2: /* Critical */
        act("@WYou raise your right hand above your head with it slightly "
            ...
            "left arm as you raise it. You slam both of your hands together, "
            "combining the energy, and then toss your @YS@yta@Yr "
            "@rB@Rr@De@ra@Rk@De@rr@W at @c$N@W! It engulfs $S head!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n@W raises $s right hand above $s head with it slightly "
            "cupped. Dark @rred@W energy begins to pool there and form a "
            "growing orb of energy. At the same time @mpurple@W arcs of "
      ...
      case 3:
        act("@WYou raise your right hand above your head with it slightly "
            ...
            "left arm as you raise it. You slam both of your hands together, "
            "combining the energy, and then toss your @YS@yta@Yr "
            "@rB@Rr@De@ra@Rk@De@rr@W at @c$N@W! It engulfs $S body!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n@W raises $s right hand above $s head with it slightly "
            "cupped. Dark @rred@W energy begins to pool there and form a "
            "growing orb of energy. At the same time @mpurple@W arcs of "
      ...
      case 4: /* Weak */
        act("@WYou raise your right hand above your head with it slightly "
            ...
            "left arm as you raise it. You slam both of your hands together, "
            "combining the energy, and then toss your @YS@yta@Yr "
            "@rB@Rr@De@ra@Rk@De@rr@W at @c$N@W! It engulfs $S arm!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n@W raises $s right hand above $s head with it slightly "
            "cupped. Dark @rred@W energy begins to pool there and form a "
            "growing orb of energy. At the same time @mpurple@W arcs of "
      ...
      case 5: /* Weak 2 */
        act("@WYou raise your right hand above your head with it slightly "
            ...
            "left arm as you raise it. You slam both of your hands together, "
            "combining the energy, and then toss your @YS@yta@Yr "
            "@rB@Rr@De@ra@Rk@De@rr@W at @c$N@W! It engulfs $S leg!@n",
            TRUE, ch, 0, vict, TO_CHAR);
        act("@C$n@W raises $s right hand above $s head with it slightly "
            "cupped. Dark @rred@W energy begins to pool there and form a "
            "growing orb of energy. At the same time @mpurple@W arcs of "
      ...
      if (level_exp(ch, GET_LEVEL(ch) + 1) - (GET_EXP(ch)) > 0 ||
          GET_LEVEL(ch) >= 100) {
        send_to_char(ch,
                     "The returning Eldritch energy blesses you with some "
                     "experience. @D[@G%s@D]@n\r\n",
                     add_commas(theft));
