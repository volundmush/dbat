...
int     char_absorbs_set(struct char_data *ch, int value);
int     char_absorbs_mod(struct char_data *ch, int delta);
void    char_handle_ingest_learn(struct char_data *ch, struct char_data *vict);
int     char_mimic_get(struct char_data *ch);
int     char_mimic_set(struct char_data *ch, int value);
...
int     char_selfdestruct_cooldown_get(struct char_data *ch);
void    char_selfdestruct_cooldown_set(struct char_data *ch, int val);
