...
# define CVSHEADER(x)	static char cvs_header[] = x
#else
# define CVSHEADER(x)	static char __attribute__((unused)) cvs_header[] = x
#endif
...
/* This logic takes the SIZEOF_foo variables from configure and uses 
   them to set up anything that depends on that knowledge */
...
#   undef _CL_UINT8
#   undef _CL_SINT8
#   define _CL_UINT8 unsigned char
#   define _CL_SINT8 signed char
# endif
# if SIZEOF_CHAR == 2
#   undef _CL_UINT16
#   undef _CL_SINT16
#   define _CL_UINT16 unsigned char
#   define _CL_SINT16 signed char
# endif
# if SIZEOF_CHAR == 4
#   undef _CL_UINT32
#   undef _CL_SINT32
#   define _CL_UINT32 unsigned char
#   define _CL_SINT32 signed char
# endif
# if SIZEOF_CHAR == 8
#   undef I64T
#   define I64T "hhd"
#   undef _CL_UINT64
#   undef _CL_SINT64
#   define _CL_UINT64 unsigned char
#   define _CL_SINT64 signed char
# endif

# if SIZEOF_SHORT == 1
#   undef _CL_UINT8
#   undef _CL_SINT8
#   define _CL_UINT8 unsigned short
#   define _CL_SINT8 signed short
# endif
# if SIZEOF_SHORT == 2
#   undef _CL_UINT16
#   undef _CL_SINT16
#   define _CL_UINT16 unsigned short
#   define _CL_SINT16 signed short
# endif
# if SIZEOF_SHORT == 4
#   undef _CL_UINT32
#   undef _CL_SINT32
#   define _CL_UINT32 unsigned short
#   define _CL_SINT32 signed short
# endif
# if SIZEOF_SHORT == 8
#   undef I64T
#   define I64T "hd"
#   undef _CL_UINT64
#   undef _CL_SINT64
#   define _CL_UINT64 unsigned short
#   define _CL_SINT64 signed short
# endif

# if SIZEOF_LONG_LONG == 1
#   undef _CL_UINT8
#   undef _CL_SINT8
#   define _CL_UINT8 unsigned long long
#   define _CL_SINT8 signed long long
# endif
# if SIZEOF_LONG_LONG == 2
#   undef _CL_UINT16
#   undef _CL_SINT16
#   define _CL_UINT16 unsigned long long
#   define _CL_SINT16 signed long long
# endif
# if SIZEOF_LONG_LONG == 4
#   undef _CL_UINT32
#   undef _CL_SINT32
#   define _CL_UINT32 unsigned long long
#   define _CL_SINT32 signed long long
# endif
...
#   undef _CL_UINT64
#   undef _CL_SINT64
#   define _CL_UINT64 unsigned long long
#   define _CL_SINT64 signed long long
# endif

# if SIZEOF_LONG == 1
#   undef _CL_UINT8
#   undef _CL_SINT8
#   define _CL_UINT8 unsigned long
#   define _CL_SINT8 signed long
# endif
# if SIZEOF_LONG == 2
#   undef _CL_UINT16
#   undef _CL_SINT16
#   define _CL_UINT16 unsigned long
#   define _CL_SINT16 signed long
# endif
# if SIZEOF_LONG == 4
#   undef _CL_UINT32
#   undef _CL_SINT32
#   define _CL_UINT32 unsigned long
#   define _CL_SINT32 signed long
# endif
# if SIZEOF_LONG == 8
#   undef I64T
#   define I64T "ld"
#   undef _CL_UINT64
#   undef _CL_SINT64
#   define _CL_UINT64 unsigned long
#   define _CL_SINT64 signed long
# endif

# if SIZEOF_INT == 1
#   undef _CL_UINT8
#   undef _CL_SINT8
#   define _CL_UINT8 unsigned int
#   define _CL_SINT8 signed int
# endif
# if SIZEOF_INT == 2
#   undef _CL_UINT16
#   undef _CL_SINT16
#   define _CL_UINT16 unsigned int
#   define _CL_SINT16 signed int
# endif
# if SIZEOF_INT == 4
#   undef _CL_UINT32
#   undef _CL_SINT32
#   define _CL_UINT32 unsigned int
#   define _CL_SINT32 signed int
# endif
# if SIZEOF_INT == 8
#   undef I64T
#   define I64T "d"
#   undef _CL_UINT64
#   undef _CL_SINT64
#   define _CL_UINT64 unsigned int
#   define _CL_SINT64 signed int
# endif

# ifdef _CL_UINT8
    typedef _CL_UINT8 cl_uint8;
# else
    FIX_CL_UINT8_IN_SYSDEP_HEADER;
# endif
# ifdef _CL_SINT8
    typedef _CL_SINT8 cl_sint8;
# else
    FIX_CL_SINT8_IN_SYSDEP_HEADER;
# endif

# ifdef _CL_UINT16
    typedef _CL_UINT16 cl_uint16;
# else
    FIX_CL_UINT16_IN_SYSDEP_HEADER;
# endif
# ifdef _CL_SINT16
    typedef _CL_SINT16 cl_sint16;
# else
    FIX_CL_SINT16_IN_SYSDEP_HEADER;
# endif

# ifdef _CL_UINT32
    typedef _CL_UINT32 cl_uint32;
# else
    FIX_CL_UINT32_IN_SYSDEP_HEADER;
# endif
# ifdef _CL_SINT32
    typedef _CL_SINT32 cl_sint32;
# else
    FIX_CL_SINT32_IN_SYSDEP_HEADER;
# endif

# ifdef _CL_UINT64 /* kludge 64 to 32 if we can't find a 64 bit type */
    typedef _CL_UINT64 cl_uint64;
# else
    typedef cl_uint32 cl_uint64;
# endif
# ifdef _CL_SINT64
    typedef _CL_SINT64 cl_sint64;
# else
    typedef cl_sint32 cl_sint64;
# endif
