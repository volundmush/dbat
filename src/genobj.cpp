...
void obj_data::setFlag(WearFlag flag, bool value) {
    if(value) {
        if(!getFlag(flag)) {
            wear_flags.insert(flag);
        }
    } else {
        if(getFlag(flag)) {
            wear_flags.erase(flag);
        }
    }
}

bool obj_data::toggleFlag(WearFlag flag) {
    if(getFlag(flag)) {
        wear_flags.erase(flag);
        return false;
    } else {
...
bool obj_data::getFlag(WearFlag flag) {
    return wear_flags.count(flag);
}

void obj_data::setFlag(ItemFlag flag, bool value) {
    if(value) {
        if(!getFlag(flag)) {
        ...
        if(getFlag(flag)) {
            item_flags.erase(flag);
        }
    }
}

bool obj_data::toggleFlag(ItemFlag flag) {
    if(getFlag(flag)) {
        item_flags.erase(flag);
        return false;
    } else {
...
bool obj_data::getFlag(ItemFlag flag) {
    return item_flags.count(flag);
}

void obj_data::setWearFlag(int flag, bool value) {
    setFlag(static_cast<WearFlag>(flag), value);
}

bool obj_data::toggleWearFlag(int flag) {
    return toggleFlag(static_cast<WearFlag>(flag));
}

bool obj_data::getWearFlag(int flag) {
    return getFlag(static_cast<WearFlag>(flag));
}

void obj_data::setItemFlag(int flag, bool value) {
    setFlag(static_cast<ItemFlag>(flag), value);
}

bool obj_data::toggleItemFlag(int flag) {
    return toggleFlag(static_cast<ItemFlag>(flag));
}
