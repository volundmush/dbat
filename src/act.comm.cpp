                        ...
                        if (granted == false && strstr(argument, "speed")) {
                            if (wch != nullptr) {
                                send_to_room(real_room(DRAGONR),
                                             ...
                                             GET_NAME(wch), WISH[0] ? "" : " Now make your second wish.");
                                wch->modAttribute(CharAttribute::Speed, 10);
                                wch->save();
                                granted = true;
                                SELFISHMETER += 1;
                        ...
                        if (granted == false && strstr(argument, "strength")) {
                            if (wch != nullptr) {
                                send_to_room(real_room(DRAGONR),
                                             ...
                                             GET_NAME(wch), WISH[0] ? "" : " Now make your second wish.");
                                wch->modAttribute(CharAttribute::Strength, 10);
                                granted = true;
                                SELFISHMETER += 1;
                        ...
                        if (granted == false && strstr(argument, "intelligence")) {
                            if (wch != nullptr) {
                                send_to_room(real_room(DRAGONR),
                                             ...
                                             GET_NAME(wch), WISH[0] ? "" : " Now make your second wish.");
                                wch->modAttribute(CharAttribute::Intelligence, 10);
                                wch->save();
                                granted = true;
                                SELFISHMETER += 1;
                        ...
                        if (granted == false && strstr(argument, "wisdom")) {
                            if (wch != nullptr) {
                                send_to_room(real_room(DRAGONR),
                                             ...
                                             GET_NAME(wch), WISH[0] ? "" : " Now make your second wish.");
                                wch->modAttribute(CharAttribute::Wisdom, 10);
                                granted = true;
                                SELFISHMETER += 1;
                        ...
                        if (granted == false && strstr(argument, "agility")) {
                            if (wch != nullptr) {
                                send_to_room(real_room(DRAGONR),
                                             ...
                                             GET_NAME(wch), WISH[0] ? "" : " Now make your second wish.");
                                wch->modAttribute(CharAttribute::Agility, 10);
                                granted = true;
                                SELFISHMETER += 1;
                        ...
                        if (granted == false && strstr(argument, "constitution")) {
                            if (wch != nullptr) {
                                send_to_room(real_room(DRAGONR),
                                             ...
                                             GET_NAME(wch), WISH[0] ? "" : " Now make your second wish.");
                                wch->modAttribute(CharAttribute::Constitution, 10);
                                granted = true;
                                SELFISHMETER += 1;
                        ...
                        if (granted == false && strstr(argument, "money")) {
                            if (wch != nullptr) {
                                send_to_room(real_room(DRAGONR),
                                             ...
                                             GET_NAME(wch), WISH[0] ? "" : " Now make your second wish.");
                                wch->modInt(CharInt::Zeni, 1000000);
                                granted = true;
                                SELFISHMETER += 1;
