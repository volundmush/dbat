...
class HasEquipment:
    ...
    def __init__(self):
        self.__equipment: dict[int, Object] = {}
    
    def get_equipment(self, slot: int) -> Object | None:
    ...
    def add_equipment(self, slot: int, obj: Object):
    ...
    def on_add_equipment(self, slot: int, obj: Object):
        pass
    
    def remove_equipment(self, slot: int) -> Object | None:
    ...
    def on_remove_equipment(self, slot: int, obj: Object):
        pass