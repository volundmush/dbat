...
#define GET_HAIRL(ch)   ((ch)->getInt(CharInt::HairLength))
#define GET_HAIRC(ch)   ((ch)->getInt(CharInt::HairColor))
#define GET_HAIRS(ch)   ((ch)->getInt(CharInt::HairStyle))
#define GET_SKIN(ch)    ((ch)->getInt(CharInt::SkinColor))
#define GET_EYE(ch)     ((ch)->getInt(CharInt::EyeColor))
#define GET_DISTFEA(ch) ((ch)->getInt(CharInt::DistinguishingFeature))
#define GET_HOME(ch)    ((ch)->hometown)
#define GET_WEIGHT(ch)  ((ch)->weight)
#define GET_HEIGHT(ch)  ((ch)->getInt(CharInt::Height))
#define GET_PC_HEIGHT(ch)    GET_HEIGHT(ch)
#define GET_PC_WEIGHT(ch)    GET_WEIGHT(ch)
#define GET_SEX(ch)    ((ch)->getInt(CharInt::Sex))
#define CARRYING(ch)    ((ch)->carrying)
#define CARRIED_BY(ch)  ((ch)->carried_by)
#define RACIAL_PREF(ch) ((ch)->getInt(CharInt::RacialPref))
...
#define GET_SONG(ch)      ((ch)->getInt(CharInt::MysticMelody))
...
#define GET_GOLD(ch)      ((ch)->getInt(CharInt::Zeni))
...
#define GET_BANK_GOLD(ch) ((ch)->getInt(CharInt::Bank))
...
#define GET_GROUPKILLS(ch)    ((ch)->getInt(CharInt::GroupKills))
...
#define GET_ALIGNMENT(ch)    ((ch)->getInt(CharInt::AlignGoodEvil))
#define GET_ETHIC_ALIGNMENT(ch)    ((ch)->getInt(CharInt::AlignLawChaos))
