...
#define NOTRADE_GOOD(i)        (SHOP_TRADE_WITH((i)).contains(TRADE_NOGOOD))
#define NOTRADE_EVIL(i)        (SHOP_TRADE_WITH((i)).contains(TRADE_NOEVIL))
#define NOTRADE_NEUTRAL(i)    (SHOP_TRADE_WITH((i)).contains(TRADE_NONEUTRAL))
#define NOTRADE_WIZARD(i)    (SHOP_TRADE_WITH((i)).contains(TRADE_NOWIZARD))
#define NOTRADE_CLERIC(i)    (SHOP_TRADE_WITH((i)).contains(TRADE_NOCLERIC))
#define NOTRADE_ROGUE(i)    (SHOP_TRADE_WITH((i)).contains(TRADE_NOROGUE))
#define NOTRADE_FIGHTER(i)    (SHOP_TRADE_WITH((i)).contains(TRADE_NOFIGHTER))
#define NOTRADE_MONK(i)        (SHOP_TRADE_WITH((i)).contains(TRADE_NOMONK))
#define NOTRADE_PALADIN(i)    (SHOP_TRADE_WITH((i)).contains(TRADE_NOPALADIN))
#define NOTRADE_HUMAN(i)        (SHOP_TRADE_WITH((i)).contains(TRADE_NOHUMAN))
#define NOTRADE_ICER(i)         (SHOP_TRADE_WITH((i)).contains(TRADE_NOICER))
#define NOTRADE_SAIYAN(i)       (SHOP_TRADE_WITH((i)).contains(TRADE_NOSAIYAN))
#define NOTRADE_KONATSU(i)      (SHOP_TRADE_WITH((i)).contains(TRADE_NOKONATSU))
#define NOTRADE_SORCERER(i)   (SHOP_TRADE_WITH((i)).contains(TRADE_NOSORCERER))
#define NOTRADE_DRUID(i)      (SHOP_TRADE_WITH((i)).contains(TRADE_NODRUID))
#define NOTRADE_BARD(i)       (SHOP_TRADE_WITH((i)).contains(TRADE_NOBARD))
#define NOTRADE_RANGER(i)     (SHOP_TRADE_WITH((i)).contains(TRADE_NORANGER))
#define NOTRADE_BARBARIAN(i)  (SHOP_TRADE_WITH((i)).contains(TRADE_NOBARBARIAN))
#define NOTRADE_HALFBREED(i)  (SHOP_TRADE_WITH((i)).contains(TRADE_NOHALFBREED))
#define NOTRADE_NAMEK(i)      (SHOP_TRADE_WITH((i)).contains(TRADE_NONAMEK))
#define NOTRADE_MUTANT(i)     (SHOP_TRADE_WITH((i)).contains(TRADE_NOMUTANT))
#define NOTRADE_ARCANE_ARCHER(i)   (SHOP_TRADE_WITH((i)).contains(TRADE_NOARCANE_ARCHER))
#define NOTRADE_ARCANE_TRICKSTER(i)(SHOP_TRADE_WITH((i)).contains(TRADE_NOARCANE_TRICKSTER))
#define NOTRADE_ARCHMAGE(i)        (SHOP_TRADE_WITH((i)).contains(TRADE_NOARCHMAGE))
#define NOTRADE_ASSASSIN(i)        (SHOP_TRADE_WITH((i)).contains(TRADE_NOASSASSIN))
#define NOTRADE_BLACKGUARD(i)      (SHOP_TRADE_WITH((i)).contains(TRADE_NOBLACKGUARD))
#define NOTRADE_DRAGON_DISCIPLE(i) (SHOP_TRADE_WITH((i)).contains(TRADE_NODRAGON_DISCIPLE))
#define NOTRADE_DUELIST(i)       (SHOP_TRADE_WITH((i)).contains(TRADE_NODUELIST))
#define NOTRADE_DWARVEN_DEFENDER(i)(SHOP_TRADE_WITH((i)).contains(TRADE_NODWARVEN_DEFENDER))
#define NOTRADE_ELDRITCH_KNIGHT(i) (SHOP_TRADE_WITH((i)).contains(TRADE_NOELDRITCH_KNIGHT))
#define NOTRADE_HIEROPHANT(i)    (SHOP_TRADE_WITH((i)).contains(TRADE_NOHIEROPHANT))
#define NOTRADE_HORIZON_WALKER(i)  (SHOP_TRADE_WITH((i)).contains(TRADE_NOHORIZON_WALKER))
#define NOTRADE_LOREMASTER(i)      (SHOP_TRADE_WITH((i)).contains(TRADE_NOLOREMASTER))
#define NOTRADE_MYSTIC_THEURGE(i)  (SHOP_TRADE_WITH((i)).contains(TRADE_NOMYSTIC_THEURGE))
#define NOTRADE_SHADOWDANCER(i)    (SHOP_TRADE_WITH((i)).contains(TRADE_NOSHADOWDANCER))
#define NOTRADE_THAUMATURGIST(i)   (SHOP_TRADE_WITH((i)).contains(TRADE_NOTHAUMATURGIST))
#define NOTRADE_BROKEN(i)       (SHOP_TRADE_WITH((i)).contains(TRADE_NOBROKEN))
...
extern std::unordered_map<shop_vnum, std::shared_ptr<Shop>> shop_index;
