...
#define VAL_LIGHT_HEALTH              VAL_ALL_HEALTH
#define VAL_LIGHT_MAXHEALTH           VAL_ALL_MAXHEALTH
#define VAL_LIGHT_UNUSED7             6
#define VAL_LIGHT_MATERIAL            VAL_ALL_MATERIAL

#define VAL_SCROLL_LEVEL              0
#define VAL_SCROLL_SPELL1             1
#define VAL_SCROLL_SPELL2             2
#define VAL_SCROLL_SPELL3             3
#define VAL_SCROLL_HEALTH             VAL_ALL_HEALTH
#define VAL_SCROLL_MAXHEALTH          VAL_ALL_MAXHEALTH
#define VAL_SCROLL_UNUSED7            6
#define VAL_SCROLL_MATERIAL           VAL_ALL_MATERIAL

#define VAL_WAND_LEVEL                0
#define VAL_WAND_MAXCHARGES           1
#define VAL_WAND_CHARGES              2
#define VAL_WAND_SPELL                3
#define VAL_WAND_HEALTH               VAL_ALL_HEALTH
#define VAL_WAND_MAXHEALTH            VAL_ALL_MAXHEALTH
#define VAL_WAND_UNUSED7              6
#define VAL_WAND_MATERIAL             VAL_ALL_MATERIAL

#define VAL_STAFF_LEVEL               0
#define VAL_STAFF_MAXCHARGES          1
#define VAL_STAFF_CHARGES             2
#define VAL_STAFF_SPELL               3
#define VAL_STAFF_HEALTH              VAL_ALL_HEALTH
#define VAL_STAFF_MAXHEALTH           VAL_ALL_MAXHEALTH
#define VAL_STAFF_UNUSED7             6
#define VAL_STAFF_MATERIAL            VAL_ALL_MATERIAL

#define VAL_WEAPON_SKILL              0
#define VAL_WEAPON_DAMDICE            1
#define VAL_WEAPON_DAMSIZE            2
#define VAL_WEAPON_DAMTYPE            3
#define VAL_WEAPON_HEALTH             VAL_ALL_HEALTH
#define VAL_WEAPON_MAXHEALTH          VAL_ALL_MAXHEALTH
#define VAL_WEAPON_CRITTYPE           6
#define VAL_WEAPON_MATERIAL           VAL_ALL_MATERIAL
...
#define VAL_FIREWEAPON_HEALTH         VAL_ALL_HEALTH
#define VAL_FIREWEAPON_MAXHEALTH      VAL_ALL_MAXHEALTH
#define VAL_FIREWEAPON_UNUSED7        6
#define VAL_FIREWEAPON_MATERIAL       VAL_ALL_MATERIAL

#define VAL_MISSILE_UNUSED1           0
#define VAL_MISSILE_UNUSED2           1
#define VAL_MISSILE_UNUSED3           2
#define VAL_MISSILE_UNUSED4           3
#define VAL_MISSILE_HEALTH            VAL_ALL_HEALTH
#define VAL_MISSILE_MAXHEALTH         VAL_ALL_MAXHEALTH
#define VAL_MISSILE_UNUSED7           6
#define VAL_MISSILE_MATERIAL          VAL_ALL_MATERIAL

#define VAL_TREASURE_UNUSED1          0
#define VAL_TREASURE_UNUSED2          1
#define VAL_TREASURE_UNUSED3          2
#define VAL_TREASURE_UNUSED4          3
#define VAL_TREASURE_HEALTH           VAL_ALL_HEALTH
#define VAL_TREASURE_MAXHEALTH        VAL_ALL_MAXHEALTH
#define VAL_TREASURE_UNUSED7          6
#define VAL_TREASURE_MATERIAL         VAL_ALL_MATERIAL

#define VAL_ARMOR_APPLYAC             0
#define VAL_ARMOR_SKILL               1
#define VAL_ARMOR_MAXDEXMOD           2
#define VAL_ARMOR_CHECK               3
#define VAL_ARMOR_HEALTH              VAL_ALL_HEALTH
#define VAL_ARMOR_MAXHEALTH           VAL_ALL_MAXHEALTH
#define VAL_ARMOR_SPELLFAIL           6
#define VAL_ARMOR_MATERIAL            VAL_ALL_MATERIAL

#define VAL_POTION_LEVEL              0
#define VAL_POTION_SPELL1             1
#define VAL_POTION_SPELL2             2
#define VAL_POTION_SPELL3             3
#define VAL_POTION_HEALTH             VAL_ALL_HEALTH
#define VAL_POTION_MAXHEALTH          VAL_ALL_MAXHEALTH
#define VAL_POTION_UNUSED7            6
#define VAL_POTION_MATERIAL           VAL_ALL_MATERIAL

#define VAL_WORN_UNUSED1              0
#define VAL_WORN_UNUSED2              1
#define VAL_WORN_UNUSED3              2
#define VAL_WORN_UNUSED4              3
#define VAL_WORN_HEALTH               VAL_ALL_HEALTH
#define VAL_WORN_MAXHEALTH            VAL_ALL_MAXHEALTH
#define VAL_WORN_UNUSED7              6
#define VAL_WORN_MATERIAL             VAL_ALL_MATERIAL

#define VAL_OTHER_UNUSED1             0
#define VAL_OTHER_UNUSED2             1
#define VAL_OTHER_UNUSED3             2
#define VAL_OTHER_UNUSED4             3
#define VAL_OTHER_HEALTH              VAL_ALL_HEALTH
#define VAL_OTHER_MAXHEALTH           VAL_ALL_MAXHEALTH
#define VAL_OTHER_UNUSED7             6
#define VAL_OTHER_MATERIAL            VAL_ALL_MATERIAL

#define VAL_TRASH_UNUSED1             0
#define VAL_TRASH_UNUSED2             1
#define VAL_TRASH_UNUSED3             2
#define VAL_TRASH_UNUSED4             3
#define VAL_TRASH_HEALTH              VAL_ALL_HEALTH
#define VAL_TRASH_MAXHEALTH           VAL_ALL_MAXHEALTH
#define VAL_TRASH_UNUSED7             6
#define VAL_TRASH_MATERIAL            VAL_ALL_MATERIAL

#define VAL_TRAP_SPELL                0
#define VAL_TRAP_HITPOINTS            1
#define VAL_TRAP_UNUSED3              2
#define VAL_TRAP_UNUSED4              3
#define VAL_TRAP_HEALTH               VAL_ALL_HEALTH
#define VAL_TRAP_MAXHEALTH            VAL_ALL_MAXHEALTH
#define VAL_TRAP_UNUSED7              6
#define VAL_TRAP_MATERIAL             VAL_ALL_MATERIAL

#define VAL_CONTAINER_CAPACITY        0
#define VAL_CONTAINER_FLAGS           1
#define VAL_CONTAINER_KEY             2
#define VAL_CONTAINER_CORPSE          3
#define VAL_CONTAINER_HEALTH          VAL_ALL_HEALTH
#define VAL_CONTAINER_MAXHEALTH       VAL_ALL_MAXHEALTH
#define VAL_CONTAINER_UNUSED7         6
#define VAL_CONTAINER_MATERIAL        VAL_ALL_MATERIAL
...
#define VAL_NOTE_HEALTH               VAL_ALL_HEALTH
#define VAL_NOTE_MAXHEALTH            VAL_ALL_MAXHEALTH
#define VAL_NOTE_UNUSED7              6
#define VAL_NOTE_MATERIAL             VAL_ALL_MATERIAL

#define VAL_DRINKCON_CAPACITY         0
#define VAL_DRINKCON_HOWFULL          1
#define VAL_DRINKCON_LIQUID           2
#define VAL_DRINKCON_POISON           3
#define VAL_DRINKCON_HEALTH           VAL_ALL_HEALTH
#define VAL_DRINKCON_MAXHEALTH        VAL_ALL_MAXHEALTH
#define VAL_DRINKCON_UNUSED7          6
#define VAL_DRINKCON_MATERIAL         VAL_ALL_MATERIAL

#define VAL_KEY_UNUSED1               0
#define VAL_KEY_UNUSED2               1
#define VAL_KEY_KEYCODE               2
#define VAL_KEY_UNUSED4               3
#define VAL_KEY_HEALTH                VAL_ALL_HEALTH
#define VAL_KEY_MAXHEALTH             VAL_ALL_MAXHEALTH
#define VAL_KEY_UNUSED7               6
#define VAL_KEY_MATERIAL              VAL_ALL_MATERIAL

#define VAL_FOOD_FOODVAL              0
#define VAL_FOOD_UNUSED2              1
#define VAL_FOOD_UNUSED3              2
#define VAL_FOOD_POISON               3
#define VAL_FOOD_HEALTH               VAL_ALL_HEALTH
#define VAL_FOOD_MAXHEALTH            VAL_ALL_MAXHEALTH
#define VAL_FOOD_UNUSED7              6
#define VAL_FOOD_MATERIAL             VAL_ALL_MATERIAL
...
#define VAL_MONEY_HEALTH              VAL_ALL_HEALTH
#define VAL_MONEY_MAXHEALTH           VAL_ALL_MAXHEALTH
#define VAL_MONEY_UNUSED7             6
#define VAL_MONEY_MATERIAL            VAL_ALL_MATERIAL

#define VAL_PEN_UNUSED1               0
#define VAL_PEN_UNUSED2               1
#define VAL_PEN_UNUSED3               2
#define VAL_PEN_UNUSED4               3
#define VAL_PEN_HEALTH                VAL_ALL_HEALTH
#define VAL_PEN_MAXHEALTH             VAL_ALL_MAXHEALTH
#define VAL_PEN_UNUSED7               6
#define VAL_PEN_MATERIAL              VAL_ALL_MATERIAL

#define VAL_BOAT_UNUSED1              0
#define VAL_BOAT_UNUSED2              1
#define VAL_BOAT_UNUSED3              2
#define VAL_BOAT_UNUSED4              3
#define VAL_BOAT_HEALTH               VAL_ALL_HEALTH
#define VAL_BOAT_MAXHEALTH            VAL_ALL_MAXHEALTH
#define VAL_BOAT_UNUSED7              6
#define VAL_BOAT_MATERIAL             VAL_ALL_MATERIAL

#define VAL_FOUNTAIN_CAPACITY         0
#define VAL_FOUNTAIN_HOWFULL          1
#define VAL_FOUNTAIN_LIQUID           2
#define VAL_FOUNTAIN_POISON           3
#define VAL_FOUNTAIN_HEALTH           VAL_ALL_HEALTH
#define VAL_FOUNTAIN_MAXHEALTH        VAL_ALL_MAXHEALTH
#define VAL_FOUNTAIN_UNUSED7          6
#define VAL_FOUNTAIN_MATERIAL         VAL_ALL_MATERIAL

#define VAL_VEHICLE_ROOM              0
#define VAL_VEHICLE_UNUSED2           1
#define VAL_VEHICLE_UNUSED3           2
#define VAL_VEHICLE_APPEAR            3
#define VAL_VEHICLE_HEALTH            VAL_ALL_HEALTH
#define VAL_VEHICLE_MAXHEALTH         VAL_ALL_MAXHEALTH
#define VAL_VEHICLE_UNUSED7           6
#define VAL_VEHICLE_MATERIAL          VAL_ALL_MATERIAL

#define VAL_HATCH_DEST                0
#define VAL_HATCH_FLAGS               1
#define VAL_HATCH_DCSKILL             2
#define VAL_HATCH_DCMOVE              3
#define VAL_HATCH_HEALTH              VAL_ALL_HEALTH
#define VAL_HATCH_MAXHEALTH           VAL_ALL_MAXHEALTH
#define VAL_HATCH_UNUSED7             6
#define VAL_HATCH_MATERIAL            VAL_ALL_MATERIAL
...
#define VAL_WINDOW_HEALTH             VAL_ALL_HEALTH
#define VAL_WINDOW_MAXHEALTH          VAL_ALL_MAXHEALTH
#define VAL_WINDOW_UNUSED7            6
#define VAL_WINDOW_MATERIAL           VAL_ALL_MATERIAL

#define VAL_CONTROL_UNUSED1           0
#define VAL_CONTROL_UNUSED2           1
#define VAL_CONTROL_UNUSED3           2
#define VAL_CONTROL_UNUSED4           3
#define VAL_CONTROL_HEALTH            VAL_ALL_HEALTH
#define VAL_CONTROL_MAXHEALTH         VAL_ALL_MAXHEALTH
#define VAL_CONTROL_UNUSED7           6
#define VAL_CONTROL_MATERIAL          VAL_ALL_MATERIAL

#define VAL_PORTAL_DEST               0
#define VAL_PORTAL_DCSKILL            1
#define VAL_PORTAL_DCMOVE             2
#define VAL_PORTAL_APPEAR             3
#define VAL_PORTAL_HEALTH             VAL_ALL_HEALTH
#define VAL_PORTAL_MAXHEALTH          VAL_ALL_MAXHEALTH
#define VAL_PORTAL_UNUSED7            6
#define VAL_PORTAL_MATERIAL           VAL_ALL_MATERIAL
...
#define VAL_BOARD_HEALTH              VAL_ALL_HEALTH
#define VAL_BOARD_MAXHEALTH           VAL_ALL_MAXHEALTH
#define VAL_BOARD_UNUSED7             6
#define VAL_BOARD_MATERIAL            VAL_ALL_MATERIAL
